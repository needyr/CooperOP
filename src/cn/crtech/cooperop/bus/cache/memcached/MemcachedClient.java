 ...
 *	log.debug("counter after adding      1: " mc.incr(key));	
 *	log.debug("counter after adding      5: " mc.incr(key, 5));	
 *	log.debug("counter after subtracting 4: " mc.decr(key, 4));	
 *	log.debug("counter after subtracting 1: " mc.decr(key));	
 * </pre> 
 ...
 *	log.debug("counter after adding      1: " mc.incr(key, 1, hash));	
 *	log.debug("counter after adding      5: " mc.incr(key, 5, hash));	
 *	log.debug("counter after subtracting 4: " mc.decr(key, 4, hash));	
 *	log.debug("counter after subtracting 1: " mc.decr(key, 1, hash));	
 * </pre> 
