...
package cn.crtech.cooperop.bus.util.javascript;
 ...
 * @author Norris Boyd
 */
public class JavaScriptShell extends ScriptableObject
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            shell.defineFunctionProperties(names, JavaScriptShell.class,
    ...
    public static void load(Context cx, Scriptable thisObj,
                            Object[] args, Function funObj)
    {
        JavaScriptShell shell = (JavaScriptShell)getTopLevelScope(thisObj);
        for (int i = 0; i < args.length; i++) {
