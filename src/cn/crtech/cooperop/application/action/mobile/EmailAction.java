package cn.crtech.cooperop.application.action.mobile;
...
public class EmailAction extends BaseAction {
	...
	public Record initEmails(Map<String, Object> req) throws Exception {
		Record rtn = new Record();
		rtn.put("emails", new EmailService().queryMine(req).getResultset());
		return rtn;
	}
