...
<head>
    ...
    <title>欢迎登录</title>
    <link href="${pageContext.request.contextPath}/theme/logins/login-cz/css/login-cz.css" rel="stylesheet"
          type="text/css"/>
</head>
<body>
<div class="login-container">
    ...
    <div class="login-footer">
        <div class="dw"><span>联合开发单位</span>四川省崇州市人民医院</div>
        <div class="copyright">
            <ul>
                <li>版权所有： ©四川医策科技有限公司</li>
                <li>网址：http://www.zgyckj.com</li>
                <li>联系电话： 028-62378387</li>
                <li>联系地址：四川省成都市武侯区星狮路711号1栋2单元302</li>
            </ul>
        </div>
    </div>
</div>
...
<script src="${pageContext.request.contextPath}/theme/scripts/controls/controls.js"
        type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/theme/logins/login-cz/scripts/login-cz.js"
        type="text/javascript"></script>
<script>
