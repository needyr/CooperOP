...
<link href="${pageContext.request.contextPath}/theme/pad/lock1.css?ipl=Y" rel="stylesheet"
	type="text/css" />
...
<div class="page-lock">
	<div class="page-body">
		...
		<div class="lock-body account-login">
			<div id="zhform">
		...
		<div class="lock-body weixin-login">
			<img alt="" src="${pageContext.request.contextPath}/theme/layout/img/chaoran_winxin.png"/>
			<p class="description">微信快速登录，需系统账号已关联绑定微信账号</p>
		</div>
		<div class="lock-body zhiwen-login">
			<div class="zhiwen-img">
				<img alt="" src="${pageContext.request.contextPath}/theme/layout/img/finger.png"/>
				<span class="finger-line"></span>
			</div>
			<p class="description">使用<font color="red">中控live20R</font>登录，需系统账号已录入绑定指纹</p>
		</div>
		<div class="lock-bottom">
			<div class="account-div qiehuan">
				<a href="javascript:void(0);" class="account-btn"><i class="cicon icon-lock"></i>账号登录</a>
			</div>
			<div class="weixin-div qiehuan">
				<a href="javascript:void(0);" class="weixin-btn"><i class="cicon icon-wchat"></i>微信登录</a>
			</div>
			<div class="zhiwen-div qiehuan">
...
<script src="${pageContext.request.contextPath}/theme/scripts/common.js?ipl=Y"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/theme/scripts/login.js?ipl=Y"
	type="text/javascript"></script>
...
<script>
	...
	var submitMe = function() {
		...
		$.call("application.auth.login", da, function(rtn) {
			if (rtn.emsg) {
				if(rtn.error_flag == 'A'){
					$.message(rtn.emsg);
				}else{
