		...
		var _ff = $this.fileupload({
			...
			uploadTemplate : function(o) {
				...
				for (var i=0, file; file=o.files[i]; i++) {
					var html = [];
					html.push('<tr class="template-upload fade">');
					html.push('<td style="width:40px;background: url(' + cooperopcontextpath + '/theme/img/filetypes/default.icon.gif) no-repeat center center;">');
					html.push('</td>');
			...
			downloadTemplate : function(o) {
				...
				for (var i=0, file; file=o.files[i]; i++) {
		            ...
		            if(file.file_id) {
		            	html.push('<a href="javascript:void(0);" file_url="' + cooperopcontextpath + '/rm/s/' + module + '/' + file.file_id + '" title="' + file.file_name + '" onclick="ccfile_show_file($(this));">' + file.file_name + '</a>');
