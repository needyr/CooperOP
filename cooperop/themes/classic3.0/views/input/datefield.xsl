...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="cooperop-datefield-link">
		<xsl:if test="descendant::cooperop-datefield">
			<link type="text/css" rel="stylesheet" href="{$contextpath}/theme/plugins/DatePicker/skin/default/datepicker.css?m={$module}"/>
			<script type="text/javascript" src="{$contextpath}/theme/plugins/DatePicker/WdatePicker.js"></script>
			<script type="text/javascript" src="{$contextpath}/theme/scripts/controls/input/datefield.js"></script>
		</xsl:if>
	</xsl:template>
