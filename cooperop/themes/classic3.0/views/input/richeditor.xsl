...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template name="cooperop-richeditor-link">
		<xsl:if test="descendant::cooperop-richeditor">
			<link rel="stylesheet" type="text/css" href="{$contextpath}/theme/plugins/bootstrap-summernote/summernote.css?m={$module}"></link>
			<script type="text/javascript" src="{$contextpath}/theme/plugins/bootstrap-summernote/summernote.js"></script>
			<script type="text/javascript" src="{$contextpath}/theme/plugins/bootstrap-summernote/lang/summernote-zh-CN.js"></script>
			<script type="text/javascript" src="{$contextpath}/theme/scripts/controls/input/richeditor.js"></script>
		</xsl:if>
	</xsl:template>
