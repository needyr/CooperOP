...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template name="cooperop-table-link">
		<xsl:if test="descendant::cooperop-table">
			<link rel="stylesheet" type="text/css" href="{$contextpath}/theme/plugins/datatables/extensions/Scroller/css/dataTables.scroller.min.css"/>
			<link rel="stylesheet" type="text/css" href="{$contextpath}/theme/plugins/datatables/extensions/ColReorder/css/dataTables.colReorder.min.css"/>
			<link rel="stylesheet" type="text/css" href="{$contextpath}/theme/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css"/>
			<link href="{$contextpath}/theme/css/components/layout/table.css" rel="stylesheet" type="text/css" />
		...
		<div class="cols{@cols}" crid="{@crid}">
			...
			<div >
				...
				<div class="portlet-body">
					...
					<table capptype="datatable" ctype="table">
					<xsl:choose>
