...
(function(cimc, window) {
	...
	cimc.init = function(params) {
		loadRES([ cimc.config.http_url + "/themes/classic4.0/im/jquery.js",
				cimc.config.http_url + "/themes/classic4.0/im/md5.js",
				cimc.config.http_url + "/themes/classic4.0/im/common.js" ], function() {
			...
			login(function(rtn) {
				...
				__res = [  //cimc.config.http_url + "/themes/classic3.0/script/ctrtc.min-2.5.7.js",
							cimc.config.http_url + "/themes/classic4.0/im/websocket.js",
							cimc.config.http_url + "/themes/classic4.0/im/instantmessager.js" ];
