...
PDFJS.imageResourcesPath = 'theme/plugins/pdfjs/web/images/';
  PDFJS.workerSrc = 'theme/plugins/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = 'theme/plugins/pdfjs/web/cmaps/';
...
function webViewerLoad(df, evt) {
window.PDFView._pdf = df;
...
function webViewerInitialized() {
  ...
  var file = window.PDFView._pdf || ('file' in params ? params.file : DEFAULT_URL);
