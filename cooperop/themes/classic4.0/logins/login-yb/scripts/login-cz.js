...
$(".login-type .zhiwen-btn").on("click", function () {
    ...
    $(".login-wrap .forms").addClass("display-hidden");
    $(".finger-div").addClass("display-show");
    $(".btn-finger").addClass("display-hidden");
    $(".btn-wechat").css("margin-left","");
    usefinger();
});
...
$(".login-type .btn-account").on("click", function () {
    ...
    $(".login-wrap .forms").removeClass("display-hidden");
    $(".finger-div").removeClass("display-show");
    $(".btn-finger").removeClass("display-hidden");
    $(".btn-wechat").css("margin-left","-10px");
    cancelfinger();
});
...
$(".login-type .weixin-btn").on("click", function () {
    ...
    $(".login-wrap .wei-div").addClass("display-show");
...
$(".wei-div .btn-close").on("click", function () {
    $(".wei-div").removeClass("display-show");
