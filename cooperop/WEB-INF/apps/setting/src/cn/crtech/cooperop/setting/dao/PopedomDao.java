...
public class PopedomDao extends BaseDao {
	...
	public Result query(Map<String, Object> params) throws Exception {
		...
		sql.append("select f.*,(select count(1) from [dbo].[system_popedom] where system_popedom_id_parent = f.id) as childnums  from [dbo].[system_popedom] f ");
	...
	public Record get(Map<String, Object> params) throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append("select *  from [dbo].[system_popedom] f ");
