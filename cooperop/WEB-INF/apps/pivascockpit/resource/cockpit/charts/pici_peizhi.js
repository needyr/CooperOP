...
//				}
				...
				for (var j = 0, r = data[j]; j < data.length; j ++, r = data[j]) {
					categories.push(r.pici + '批次');
					peizhi_count_.push(r.peizhi_count - 0);
					nopeizhi_count_.push(r.nopeizhi_count - 0);
					tuiy_count_.push(r.tuiy_count - 0);
					html.push('		<div><span>' + r.pici + '批次: </span><em class="c-white">' + r.pici_count + '</em>/<em class="c-green">' + r.peizhi_count + '</em>/<em class="c-blue">' + r.nopeizhi_count + '</em>/<em class="c-red">' + r.tuiy_count + '</em></div>');
				}
