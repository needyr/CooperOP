    ...
    <div class="btn-content btn-content1" style="height: calc(100% - 50px);">
        <table border="">
            ...
            <tr class="a1 ${empty oo.level?'':'active'}">
                ...
                <td style="width: 40px;"><fmt:formatNumber type="number" value="${oo.shl}"  />${oo.drug_unit}</td>
                ...
                <td style="width: 60px;">
                <c:if test="${not empty oo.beizhu}">
                ${oo.beizhu}
                </c:if>
                </td>
                <c:if test="${oo.order_status eq 0}">
					<td style="color: #00a093;width: 60px;">新开医嘱</td>
				</c:if>
				<c:if test="${oo.order_status ne 0}">
