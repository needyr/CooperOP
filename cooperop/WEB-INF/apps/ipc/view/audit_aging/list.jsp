...
<s:row>
<s:table action="ipc.audit_aging.list" sort="true" label="强制用药列表" autoload="true" id="table">
	<s:toolbar>
	...
	<s:table.field name="caozuo" label="操作" datatype="script">
		return '<a onclick="detailinfo(\''+record.common_id+'\');">详情 </a>|||<a onclick="pass(\''+record.id+'\',\'Y\');"> 通过 </a><a onclick="pass(\''+record.id+'\',\'N\');"> 不通过  </a>';
	</s:table.field>
	</s:table.fields>
</s:table>
</s:row>
...
function detailinfo(id){
	$.modal("/w/hospital_common/showturns/detailshow.html","审查信息",{
		width:"940px",
		height:"98%",
		id: id,
		callback : function(e){
...
/* function detailinfo(id){
	$.modal("/w/ipc/audit_aging/druglist.html","审查信息",{
		width:"940px",
		height:"98%",
		id: id,
		callback : function(e){
...
function pass(auto_audit_id,state){
	...
	$.confirm("是否确认"+content+"？",function callback(e){
		if(e==true){
			$.call("ipc.audit_aging.ispass",{id:auto_audit_id,state:state},function(rtn){
				if(rtn == 0){
