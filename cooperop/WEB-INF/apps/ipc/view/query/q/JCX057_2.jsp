...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="JCX057_2" init-action="" description="不合理审查问题查看" system_product_code="ipc" title="不合理审查问题查看" remark="" flag="q" type="query"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.query.q.JCX057_2", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.query.q.JCX057_2", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.query.q.JCX057_2", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.query.q.JCX057_2", null);
	}
...
<s:row><s:form label="医嘱审查问题查询" icon="fa fa-list-alt" color="default" border="1" cols="4" istoorbar="Y" app_collapsed="Y"><s:row type="frow"><s:datefield label="开始日期" cols="1" name="start_date" value="${empty start_date ? rq : start_date}" placeholder="" fdtype="字符" defaultValue="${rq}" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="10" precision=""></s:datefield>
<s:timefield label="开始时间" cols="1" name="start_time" value="${empty start_time ? '00:00' : start_time}" placeholder="" fdtype="字符" defaultValue="00:00" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="8" precision=""></s:timefield>
</s:row>
<s:row type="frow"><s:datefield label="截止日期" cols="1" name="end_date" value="${empty end_date ? rq : end_date}" placeholder="" fdtype="字符" defaultValue="${rq}" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="10" precision=""></s:datefield>
<s:timefield label="截止时间" cols="1" name="end_time" value="${empty end_time ? '23:59' : end_time}" placeholder="" fdtype="字符" defaultValue="23:59" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="8" precision=""></s:timefield>
</s:row>
...
<s:textfield color="grey" label="科室名称" name="dept_name" placeholder="" fdtype="字符" cols="1" defaultValue="全部" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="zl_select_JCX057_2_01" out_action="" tableid="" expressions="" maxlength="128" precision="">${empty dept_name ? '全部' : dept_name}</s:textfield>
</s:row>
...
<s:row><s:tabpanel color="grey-silver" cols="4"><s:table label="不合格医嘱" cols="4" color="grey-silver" active="true" isdesign_="Y" tableid="01" icon="glyphicon glyphicon-question-sign" djselect="" tablekey="" limit="25" toIndex="0" sort="true" autoload="false" istoorbar="Y" myIndex="0" fields="" app_table="false" height="" totals="" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="patient_name" value="$[patient_name]"  fdtype="字符" format="" dictionary="" label="患者姓名" size="1280" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="left" width="120" fieldorder="" is_href="hospital_common.additional.patientInfo" app_field="" datatype="template"><s:textfield readonly="true" name="patient_name" value="$[patient_name]"  fdtype="字符" format="" dictionary="" size="1280" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="left" width="120" fieldorder="" is_href="hospital_common.additional.patientInfo" app_field="">null</s:textfield>
</s:table.field>
...
<s:table.field name="shenc_change_level_name" fdtype="" format="" dictionary="" label="调整后级别" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="shenc_pass_ren" fdtype="字符" format="" dictionary="" label="调整人" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="shenc_pass_pharmacist_advice" fdtype="字符" format="" dictionary="" label="调整药师意见" size="100" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="shenc_pass_time" fdtype="字符" format="" dictionary="" label="调整时间" size="19" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="170" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
