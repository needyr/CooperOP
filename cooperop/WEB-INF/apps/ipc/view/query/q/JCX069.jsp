...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="JCX069" init-action="" description="基本药物使用点评" system_product_code="ipc" title="基本药物使用点评" remark="基本药物使用点评" flag="q" type="query"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.query.q.JCX069", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.query.q.JCX069", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.query.q.JCX069", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.query.q.JCX069", null);
	}
...
<s:row><s:table label="基本药物处方点评" cols="4" color="grey-silver" isdesign_="Y" tableid="01" icon="" djselect="" tablekey="" limit="25" sort="true" autoload="false" istoorbar="N" fields="" app_table="false" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="spcomment_name" fdtype="字符" format="" dictionary="" label="点评类型" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="150" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="comment_datetime" fdtype="字符" format="" dictionary="" label="点评时间" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="100" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="patient_name" value="$[patient_name]"  fdtype="字符" format="" dictionary="" label="患者姓名" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="left" width="120" fieldorder="" is_href="hospital_common.showturns.patientdetail" app_field="" datatype="template"><s:textfield readonly="true" name="patient_name" value="$[patient_name]"  fdtype="字符" format="" dictionary="" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="left" width="120" fieldorder="" is_href="hospital_common.showturns.patientdetail" app_field="">null</s:textfield>
</s:table.field>
...
<s:table.field name="shl" fdtype="实数" format="" dictionary="" label="药品数" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="j_shl" fdtype="实数" format="" dictionary="" label="基药数" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="" is_href="" app_field=""></s:table.field>
...
<s:table.field name="sf_ji" fdtype="字符" format="" dictionary="" label="是否基药" size="5" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:row>
</s:page>
