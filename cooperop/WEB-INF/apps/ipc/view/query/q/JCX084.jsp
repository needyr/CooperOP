...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="JCX084" init-action="" description="住院医嘱质量层次点评汇总" system_product_code="ipc" title="住院医嘱质量层次点评汇总" remark="住院医嘱质量层次点评汇总" flag="q" type="query"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.query.q.JCX084", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.query.q.JCX084", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.query.q.JCX084", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.query.q.JCX084", null);
	}
...
<s:toolbar><s:button label="保存" icon="glyphicon glyphicon-search" nextfocusfield="" action="querymx" color=""></s:button>
</s:toolbar>
...
<s:row><s:tabpanel color="grey-silver" cols="4"><s:table label="住院医嘱质量层次点评汇总" cols="4" color="grey-silver" active="true" isdesign_="Y" tableid="01" icon="" djselect="" tablekey="" limit="25" toIndex="0" app_table="false" sort="false" autoload="false" istoorbar="N" myIndex="0" fields="" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="patient_name" fdtype="字符" format="" dictionary="" label="患者姓名" size="32" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
...
<s:table.field name="shl" fdtype="实数" format="" dictionary="" label="病历总数" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp1" fdtype="实数" format="" dictionary="" label="诊断用药相符" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp2" fdtype="实数" format="" dictionary="" label="诊断用药不相符" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp3" fdtype="实数" format="" dictionary="" label="选药适宜" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp4" fdtype="实数" format="" dictionary="" label="选药不适宜" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp5" fdtype="实数" format="" dictionary="" label="用法用量正确" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp6" fdtype="实数" format="" dictionary="" label="用法用量不正确" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp7" fdtype="实数" format="" dictionary="" label="无联用或重复用药" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp8" fdtype="实数" format="" dictionary="" label="有联用或重复用药" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:tabpanel>
</s:row>
