...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="JCX070" init-action="" description="糖皮质激素医嘱点评" system_product_code="ipc" title="糖皮质激素医嘱点评" remark="糖皮质激素医嘱点评" flag="q" type="query"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.query.q.JCX070", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.query.q.JCX070", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.query.q.JCX070", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.query.q.JCX070", null);
	}
...
<s:row><s:table label="糖皮质激素医嘱点评" cols="4" color="grey-silver" isdesign_="Y" tableid="01" icon="" djselect="" tablekey="" limit="25" sort="true" autoload="false" istoorbar="N" fields="" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="spcomment_name" fdtype="字符" format="" dictionary="" label="点评名称" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="comment_datetime" fdtype="字符" format="" dictionary="" label="点评时间" size="32" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="patient_name" value="$[patient_name]"  fdtype="字符" format="" dictionary="" label="患者姓名" size="255" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="left" width="120" fieldorder="" is_href="hospital_common.showturns.patientdetail" app_field="" datatype="template"><s:textfield readonly="true" name="patient_name" value="$[patient_name]"  fdtype="字符" format="" dictionary="" size="255" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="left" width="120" fieldorder="" is_href="hospital_common.showturns.patientdetail" app_field="">null</s:textfield>
</s:table.field>
<s:table.field name="doctor" fdtype="字符" format="" dictionary="" label="医生姓名" size="32" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
...
<s:table.field name="ordermessage" fdtype="字符" format="" dictionary="" label="医嘱信息" size="2000" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="300" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp1" fdtype="实数" format="" dictionary="" label="适应症" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp2" fdtype="实数" format="" dictionary="" label="药物选择" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp3" fdtype="实数" format="" dictionary="" label="用法用量" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp4" fdtype="实数" format="" dictionary="" label="疗程" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dp5" fdtype="实数" format="" dictionary="" label="用药禁忌" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:row>
</s:page>
