...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="A013" init-action="" flag="IPC" description="超说明书用药申请_查看" system_product_code="ipc" djzy="超说明书用药申请_查看" helpno="超说明书用药申请_查看" title="超说明书用药申请_查看" remark="" printmx="" sub="" modalwidth="" modalheight="" djprintsql="" othermxsql="" type="bill"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.bill.IPC.A013", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.bill.IPC.A013", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.bill.IPC.A013", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.bill.IPC.A013", null);
	}
...
<s:row><s:form label="超说明书用药申请" icon="fa fa-list-alt" color="grey-silver" border="1" cols="4" istoorbar="Y"><s:row type="frow"><s:textfield label="" cols="4" name="message_a" placeholder="以下为超说明书用药申请信息" fdtype="字符" defaultValue="以下为超说明书用药申请信息" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="2000" precision="">${empty message_a ? '以下为超说明书用药申请信息' : message_a}</s:textfield>
</s:row>
<s:row type="frow"><s:datefield label="申请日期" cols="1" name="rq" value="${empty rq ? '' : rq}" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="10" precision=""></s:datefield>
...
<s:row type="frow"><s:file label="附件" cols="4" name="filename" value="${empty filename ? '' : filename}" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" deleteable="false" addable="false" downloadable="true" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="40" precision=""></s:file>
<s:image color="grey" label="" name="imagename" value="${empty imagename ? '' : imagename}" placeholder="" fdtype="字符" cols="4" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" deleteable="false" addable="false" downloadable="true" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="512" precision=""></s:image>
</s:row>
<s:row type="frow"></s:row>
<s:row type="frow"><s:textarea label="药师审核意见" cols="4" name="pharmacist_shenhe_message" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="2000" precision="">${empty pharmacist_shenhe_message ? '' : pharmacist_shenhe_message}</s:textarea>
</s:row>
...
<s:textarea label="主任审核意见" cols="4" name="director_shenhe_message" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="512" precision="">${empty director_shenhe_message ? '' : director_shenhe_message}</s:textarea>
</s:row>
<s:toolbar><s:button label="打印" icon="glyphicon glyphicon-print" nextfocusfield="" action="da_yin_IPCA013_02" color=""></s:button>
</s:toolbar>
</s:form>
</s:row>
</s:page>
