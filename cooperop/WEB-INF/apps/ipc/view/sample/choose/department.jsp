...
if('${param.code}'){
	var code = '${param.code}';
	$.call("hospital_common.department.searchCheck",{code: code.split(','),datasouce: jQuery.parseJSON('${param.datasouce}')},function(rtn){
		if(rtn.dept){
			var html = [];
			var v = rtn.dept;
...
function search1(){
	...
	$.call("hospital_common.department.querySearch",{data: data,datasouce: jQuery.parseJSON('${param.datasouce}')},function(rtn){
		if(rtn.dept){
			var html = [];
			var v = rtn.dept;
			for(i=0;i<v.length;i++){
