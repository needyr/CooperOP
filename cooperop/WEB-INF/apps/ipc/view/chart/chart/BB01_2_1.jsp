...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB01_2_1" init-action="" description="审查不合格分类[更多]->科室->医生" system_product_code="ipc" title="审查不合格分类[更多]➩科室➩医生" remark="审查不合格分类[更多]➩科室➩医生" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB01_2_1", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB01_2_1", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB01_2_1", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB01_2_1", null);
	}
...
<s:row><s:tabpanel color="grey-silver" cols="4"><s:table label="审查不合格分类[更多]_科室_医生" cols="4" color="grey-silver" active="true" isdesign_="Y" tableid="01" icon="glyphicon glyphicon-sort-by-attributes" autoload="true" toIndex="0" sort="true" myIndex="0" djselect="ipc.chart.chart.BB01_2_1_1" subpage_name="审查不合格分类[更多]➩科室➩医生[:doctor]➩病人" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="dept_name" value="${empty dept_name ? '' : dept_name}" fdtype="字符" format="" dictionary="" label="科室名称" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="150" fieldorder="0" is_href="" app_field=""></s:table.field>
<s:table.field name="doctor" value="${empty doctor ? '' : doctor}" fdtype="字符" format="" dictionary="" label="医生" size="32" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="1" is_href="" app_field=""></s:table.field>
<s:table.field name="用法用量" value="${empty 用法用量 ? '' : 用法用量}" fdtype="实数	" format="" dictionary="" label="用法用量" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="2" is_href="" app_field=""></s:table.field>
<s:table.field name="溶媒问题l" value="${empty 溶媒问题l ? '' : 溶媒问题l}" fdtype="实数	" format="" dictionary="" label="溶媒问题" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="3" is_href="" app_field=""></s:table.field>
<s:table.field name="给药途径" value="${empty 给药途径 ? '' : 给药途径}" fdtype="实数	" format="" dictionary="" label="给药途径" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="4" is_href="" app_field=""></s:table.field>
<s:table.field name="配伍禁忌" value="${empty 配伍禁忌 ? '' : 配伍禁忌}" fdtype="实数	" format="" dictionary="" label="配伍禁忌" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="5" is_href="" app_field=""></s:table.field>
<s:table.field name="相互作用" value="${empty 相互作用 ? '' : 相互作用}" fdtype="实数	" format="" dictionary="" label="相互作用" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="6" is_href="" app_field=""></s:table.field>
<s:table.field name="适应症" value="${empty 适应症 ? '' : 适应症}" fdtype="实数	" format="" dictionary="" label="适应症" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="7" is_href="" app_field=""></s:table.field>
<s:table.field name="禁忌症" value="${empty 禁忌症 ? '' : 禁忌症}" fdtype="实数	" format="" dictionary="" label="禁忌症" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="8" is_href="" app_field=""></s:table.field>
<s:table.field name="儿童老年人用药" value="${empty 儿童老年人用药 ? '' : 儿童老年人用药}" fdtype="实数	" format="" dictionary="" label="儿童老年人用药" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="9" is_href="" app_field=""></s:table.field>
<s:table.field name="病生理状" value="${empty 病生理状 ? '' : 病生理状}" fdtype="实数	" format="" dictionary="" label="病生理状" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="10" is_href="" app_field=""></s:table.field>
<s:table.field name="重复用药" value="${empty 重复用药 ? '' : 重复用药}" fdtype="实数	" format="" dictionary="" label="重复用药" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="11" is_href="" app_field=""></s:table.field>
<s:table.field name="医保" value="${empty 医保 ? '' : 医保}" fdtype="实数	" format="" dictionary="" label="医保" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="12" is_href="" app_field=""></s:table.field>
<s:table.field name="超级使用" value="${empty 超级使用 ? '' : 超级使用}" fdtype="实数	" format="" dictionary="" label="超级使用" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="13" is_href="" app_field=""></s:table.field>
<s:table.field name="无正当理由用药" value="${empty 无正当理由用药 ? '' : 无正当理由用药}" fdtype="实数	" format="" dictionary="" label="无正当理由用药" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="14" is_href="" app_field=""></s:table.field>
<s:table.field name="跨性别用药" value="${empty 跨性别用药 ? '' : 跨性别用药}" fdtype="实数	" format="" dictionary="" label="跨性别用药" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="15" is_href="" app_field=""></s:table.field>
<s:table.field name="药品使用问题" value="${empty 药品使用问题 ? '' : 药品使用问题}" fdtype="实数	" format="" dictionary="" label="药品使用问题" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="16" is_href="" app_field=""></s:table.field>
<s:table.field name="处方使用问题" value="${empty 处方使用问题 ? '' : 处方使用问题}" fdtype="实数	" format="" dictionary="" label="处方使用问题" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="17" is_href="" app_field=""></s:table.field>
<s:table.field name="其它" value="${empty 其它 ? '' : 其它}" fdtype="实数	" format="" dictionary="" label="其它" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="18" is_href="" app_field=""></s:table.field>
<s:table.field name="doctor_no" value="${empty doctor_no ? '' : doctor_no}" fdtype="字符" format="" dictionary="" label="医生编号" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="19" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:tabpanel>
</s:row>
