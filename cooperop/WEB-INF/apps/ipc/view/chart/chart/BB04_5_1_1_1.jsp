...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB04_5_1_1_1" init-action="" description="点评不合格科室[更多]->科室名称->不合格分类->医生姓名->患者信息" system_product_code="ipc" title="点评不合格科室[更多]->科室名称->不合格分类->医生姓名->患者信息" remark="点评不合格科室[更多]->科室名称->不合格分类->医生姓名->患者信息" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB04_5_1_1_1", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB04_5_1_1_1", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB04_5_1_1_1", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB04_5_1_1_1", null);
	}
...
<s:textfield label="不合格分类" cols="1" name="comment_jiancheng" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="128" precision="">${empty comment_jiancheng ? '' : comment_jiancheng}</s:textfield>
...
<s:table.field name="comment_jiancheng" value="${empty comment_jiancheng ? '' : comment_jiancheng}" fdtype="字符" format="" dictionary="" label="不合格分类" size="50" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="drug_name" value="${empty drug_name ? '' : drug_name}" fdtype="字符" format="" dictionary="" label="药品名称" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="250" fieldorder="" is_href="" app_field=""></s:table.field>
