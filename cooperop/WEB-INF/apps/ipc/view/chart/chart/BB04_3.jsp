...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB04_3" init-action="" description="点评问题分类[更多]->问题结果" system_product_code="ipc" title="点评问题分类[更多]->问题结果" remark="点评问题分类[更多]->问题结果" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB04_3", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB04_3", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB04_3", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB04_3", null);
	}
...
<s:row><s:table label="点评问题分类[更多]->问题结果" cols="4" color="grey-silver" isdesign_="Y" tableid="01" icon="" djselect="ipc.chart.chart.BB04_3_1" subpage_name="点评问题分类[更多]->问题结果->患者信息" autoload="true" sort="false" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="comment_name" value="${empty comment_name ? '' : comment_name}" fdtype="字符" format="" dictionary="" label="点评问题名称" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="400" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="shl" value="${empty shl ? '' : shl}" fdtype="实数" format="" dictionary="" label="抽样数量" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="cc_shl" value="${empty cc_shl ? '' : cc_shl}" fdtype="实数" format="" dictionary="" label="超常处方" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="ccl" value="${empty ccl ? '' : ccl}" fdtype="实数" format="" dictionary="" label="不合格率" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="bsy_shl" value="${empty bsy_shl ? '' : bsy_shl}" fdtype="实数" format="" dictionary="" label="不适宜处方" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
...
<s:table.field name="bgf_shl" value="${empty bgf_shl ? '' : bgf_shl}" fdtype="实数" format="" dictionary="" label="不规范处方" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
