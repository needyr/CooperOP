...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB01_41_1_1" init-action="" description="审查不合格药品[下钻]->审查类型->科室->患者" system_product_code="ipc" title="审查不合格药品[下钻]➩审查类型➩科室➩患者" remark="审查不合格药品[下钻]➩审查类型➩科室➩患者" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB01_41_1_1", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB01_41_1_1", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB01_41_1_1", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB01_41_1_1", null);
	}
...
<s:row><s:form label="审查结果下钻" icon="fa fa-list-alt" color="grey-silver" border="1" cols="4" istoorbar="Y"><s:row type="frow"><s:textfield label="审查类型" cols="1" name="sort_name" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="50" precision="">${empty sort_name ? '' : sort_name}</s:textfield>
...
<s:textfield label="药品名称" cols="1" name="xaxis" placeholder="" fdtype="字符" defaultValue=":xaxis" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="128" precision="">${empty xaxis ? ':xaxis' : xaxis}</s:textfield>
...
<s:textfield label="药品代码" cols="1" name="drug_code" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="32" precision="">${empty drug_code ? '' : drug_code}</s:textfield>
</s:row>
...
<s:row><s:tabpanel color="grey-silver" cols="4"><s:table label="审查不合格药品[更多]➩审查类型➩科室➩患者" cols="4" color="grey-silver" active="true" isdesign_="Y" tableid="01" icon="icon-user-following" autoload="true" toIndex="0" sort="false" myIndex="0" djselect="" subpage_name="" limit="25" app_table="N" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="dept_name" value="${empty dept_name ? '' : dept_name}" fdtype="字符" format="" dictionary="" label="科室名称" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="0" is_href="" app_field=""></s:table.field>
<s:table.field name="doctor" value="${empty doctor ? '' : doctor}" fdtype="字符" format="" dictionary="" label="医生" size="32" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="100" fieldorder="1" is_href="" app_field=""></s:table.field>
<s:table.field name="patient_name" value="$[patient_name]"  fdtype="字符" format="" dictionary="" label="患者姓名" size="1280" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="left" width="150" fieldorder="2" is_href="hospital_common.patient.index" app_field="" datatype="template"><s:textfield readonly="true" name="patient_name" value="$[patient_name]"  fdtype="字符" format="" dictionary="" size="1280" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="left" width="150" fieldorder="2" is_href="hospital_common.patient.index" app_field="">null</s:textfield>
</s:table.field>
<s:table.field name="check_level_name" value="${empty check_level_name ? '' : check_level_name}" fdtype="字符" format="" dictionary="" label="严重程度" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="3" is_href="" app_field=""></s:table.field>
<s:table.field name="sort_name" value="${empty sort_name ? '' : sort_name}" fdtype="字符" format="" dictionary="" label="审查类型" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="80" fieldorder="4" is_href="" app_field=""></s:table.field>
<s:table.field name="related_drugs_show" value="${empty related_drugs_show ? '' : related_drugs_show}" datatype="script"  fdtype="字符" format="" dictionary="" label="药品信息" size="1024" maxlength_show="60" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="200" fieldorder="5" is_href="" app_field=""> var html = [];  if(record.related_drugs_show && record.related_drugs_show.length>60){  	html.push('<a href="javascript:void(0);" title="'+record.related_drugs_show+'" style="cursor: pointer;"');  	html.push(' onclick="show_maxlength(this);" ');  	html.push('>');  	html.push(record.related_drugs_show.substring(0,60)+'……');  	html.push('</a>');  }else{  	html.push(record.related_drugs_show);  }  return html.join(''); </s:table.field>
<s:table.field name="audit_source_type" value="${empty audit_source_type ? '' : audit_source_type}" fdtype="字符" format="" dictionary="" label="审查来源" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="6" is_href="" app_field=""></s:table.field>
<s:table.field name="description" value="${empty description ? '' : description}" datatype="script"  fdtype="文本" format="" dictionary="" label="描述" size="" maxlength_show="60" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="350" fieldorder="7" is_href="" app_field=""> var html = [];  if(record.description && record.description.length>60){  	html.push('<a href="javascript:void(0);" title="'+record.description+'" style="cursor: pointer;"');  	html.push(' onclick="show_maxlength(this);" ');  	html.push('>');  	html.push(record.description.substring(0,60)+'……');  	html.push('</a>');  }else{  	html.push(record.description);  }  return html.join(''); </s:table.field>
<s:table.field name="reference" value="${empty reference ? '' : reference}" datatype="script"  fdtype="字符" format="" dictionary="" label="参考" size="500" maxlength_show="8" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="100" fieldorder="8" is_href="" app_field=""> var html = [];  if(record.reference && record.reference.length>8){  	html.push('<a href="javascript:void(0);" title="'+record.reference+'" style="cursor: pointer;"');  	html.push(' onclick="show_maxlength(this);" ');  	html.push('>');  	html.push(record.reference.substring(0,8)+'……');  	html.push('</a>');  }else{  	html.push(record.reference);  }  return html.join(''); </s:table.field>
<s:table.field name="check_datetime" value="${empty check_datetime ? '' : check_datetime}" fdtype="字符" format="" dictionary="" label="审查日期" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="160" fieldorder="9" is_href="" app_field=""></s:table.field>
<s:table.field name="doctor_advice" value="${empty doctor_advice ? '' : doctor_advice}" fdtype="字符" format="" dictionary="" label="医生意见" size="100" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="10" is_href="" app_field=""></s:table.field>
<s:table.field name="yaoshi_advice" value="${empty yaoshi_advice ? '' : yaoshi_advice}" fdtype="字符" format="" dictionary="" label="药师意见" size="1000" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="11" is_href="" app_field=""></s:table.field>
<s:table.field name="yaoshi_name" value="${empty yaoshi_name ? '' : yaoshi_name}" fdtype="字符" format="" dictionary="" label="药师名称" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="12" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:tabpanel>
</s:row>
