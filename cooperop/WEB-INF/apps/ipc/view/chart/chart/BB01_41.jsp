...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB01_41" init-action="" description="审查不合理药品[下钻]->审查类型" system_product_code="ipc" title="审查不合理药品➩审查类型" remark="审查不合理药品➩审查类型" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB01_41", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB01_41", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB01_41", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB01_41", null);
	}
...
<s:textfield label="药品名称" cols="1" name="xaxis" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="128" precision="">${empty xaxis ? '' : xaxis}</s:textfield>
...
<s:row><s:tabpanel color="grey-silver" cols="4"><s:table label="审查不合理药品➩审查类型" cols="4" color="grey-silver" active="true" isdesign_="Y" tableid="01" icon="glyphicon glyphicon-sort-by-attributes" autoload="true" toIndex="0" sort="false" myIndex="0" djselect="ipc.chart.chart.BB01_41_1" subpage_name="审查不合理药品➩[:xaxis]➩[:sort_name]➩科室" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="sort_name" value="${empty sort_name ? '' : sort_name}" fdtype="字符" format="" dictionary="" label="问题类型" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="center" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="order_shl" value="${empty order_shl ? '' : order_shl}" fdtype="字符" format="" dictionary="" label="医嘱总数（个）" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="center" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="sortname_shl" value="${empty sortname_shl ? '' : sortname_shl}" fdtype="字符" format="" dictionary="" label="问题总数（个）" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="center" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="sortname_BL" value="$[sortname_bl]"  fdtype="实数" format="" dictionary="" label="问题比例（%）" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="textfield" align="right" width="200" fieldorder="" is_href="" app_field="" datatype="template"><s:textfield readonly="true" name="sortname_BL" value="$[sortname_bl]"  fdtype="实数" format="" dictionary="" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="textfield" align="right" width="200" fieldorder="" is_href="" app_field="">null</s:textfield>
</s:table.field>
<s:table.field name="sort_id" value="${empty sort_id ? '' : sort_id}" fdtype="字符" format="" dictionary="" label="问题类型ID" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="150" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:tabpanel>
</s:row>
