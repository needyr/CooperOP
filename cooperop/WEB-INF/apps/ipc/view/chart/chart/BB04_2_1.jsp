...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB04_2_1" init-action="" description="点评不合格药品分类[更多]->药品分类->科室名称" system_product_code="ipc" title="点评不合格药品分类[更多]->药品分类->科室名称" remark="点评不合格药品分类[更多]->药品分类->科室名称" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB04_2_1", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB04_2_1", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB04_2_1", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB04_2_1", null);
	}
...
<s:table.field name="hgl" value="$[hgl]"  fdtype="实数" format="" dictionary="" label="不合格率" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="textfield" align="left" width="150" fieldorder="" is_href="" app_field="" datatype="template"><s:textfield readonly="true" name="hgl" value="$[hgl]"  fdtype="实数" format="" dictionary="" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="textfield" align="left" width="150" fieldorder="" is_href="" app_field="">null</s:textfield>
</s:table.field>
