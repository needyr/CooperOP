...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="shenf_jg" init-action="" description="审方结果导出" system_product_code="ipc" title="审方结果导出" remark="审方结果导出" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.shenf_jg", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.shenf_jg", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.shenf_jg", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.shenf_jg", null);
	}
...
<s:row><s:table label="住院审方结果查询导出" cols="4" color="grey-silver" isdesign_="Y" tableid="shengfang_jg1" icon="" djselect="" subpage_name="" autoload="false" limit="50" sort="false" app_table="N" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="level" value="${empty level ? '' : level}" fdtype="" format="" dictionary="" label="拦截等级" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="0" is_href="" app_field=""></s:table.field>
<s:table.field name="order_text" value="${empty order_text ? '' : order_text}" fdtype="" format="" dictionary="" label="医嘱名称" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="1" is_href="" app_field=""></s:table.field>
<s:table.field name="dept_name" value="${empty dept_name ? '' : dept_name}" fdtype="" format="" dictionary="" label="部门" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="2" is_href="" app_field=""></s:table.field>
<s:table.field name="doctor" value="${empty doctor ? '' : doctor}" fdtype="" format="" dictionary="" label="医师姓名" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="3" is_href="" app_field=""></s:table.field>
<s:table.field name="patient_id" value="$[patient_id]"  fdtype="" format="" dictionary="" label="患者id" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="textfield" align="left" width="60" fieldorder="4" is_href="hospital_common.patient.index" app_field="" datatype="template"><s:textfield readonly="true" name="patient_id" value="$[patient_id]"  fdtype="" format="" dictionary="" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="textfield" align="left" width="60" fieldorder="4" is_href="hospital_common.patient.index" app_field="">null</s:textfield>
</s:table.field>
<s:table.field name="description" value="${empty description ? '' : description}" fdtype="" format="" dictionary="" label="违规说明" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="220" fieldorder="5" is_href="" app_field=""></s:table.field>
<s:table.field name="reference" value="${empty reference ? '' : reference}" fdtype="" format="" dictionary="" label="来源" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="6" is_href="" app_field=""></s:table.field>
