...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB01_1" init-action="" description="审查合理比例->审查类型" system_product_code="ipc" title="审查合理比例➩审查类型" remark="审查合理比例➩审查类型" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB01_1", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB01_1", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB01_1", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB01_1", null);
	}
...
<s:row><s:form label="审查合理比例➩审查类型" icon="fa fa-list-alt" color="grey-silver" border="1" cols="4" istoorbar="Y"><s:toolbar><s:button label="刷新" icon="icon-reload" nextfocusfield="" action="querymx" color=""></s:button>
...
<s:radio label="" cols="1" name="is_dengji" value="${empty is_dengji ? '2' : is_dengji}" placeholder="" fdtype="字符" defaultValue="2" format="" nextfocusfield="" islabel="0" readonly="true" required="0" encryption="0" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" clabel="全部" contentIndex="0" contentvalue="0" maxlength="10" precision=""><s:option label="全部" contentIndex="0" value="0"></s:option>
...
<s:select label="医嘱/处方" cols="1" name="p_type" value="${empty p_type ? '0' : p_type}" placeholder="" fdtype="字符" defaultValue="0" format="" nextfocusfield="" islabel="0" readonly="true" required="0" encryption="0" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" clabel="全部" contentIndex="0" contentvalue="0" maxlength="8" precision=""><s:option label="全部" contentIndex="0" value="0"></s:option>
...
<s:row><s:tabpanel color="grey-silver" cols="4"><s:table label="审查合理比例➩审查类型" cols="4" color="grey-silver" active="true" isdesign_="Y" tableid="01" icon="glyphicon glyphicon-sort-by-attributes" autoload="true" toIndex="0" sort="false" myIndex="0" djselect="ipc.chart.chart.BB01_1_1" subpage_name="审查合理比例➩审查类型➩病人" limit="25" app_table="N" fitwidth="true" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="sort_name" value="$[sort_name]"  fdtype="字符" format="" dictionary="" label="问题类型" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="center" width="200" fieldorder="" is_href="ipc.chart.chart.BB01_1_1" app_field="" datatype="template"><s:textfield readonly="true" name="sort_name" value="$[sort_name]"  fdtype="字符" format="" dictionary="" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="center" width="200" fieldorder="" is_href="ipc.chart.chart.BB01_1_1" app_field="">null</s:textfield>
</s:table.field>
<s:table.field name="sortname_shl" value="$[sortname_shl]"  fdtype="字符" format="" dictionary="" label="问题医嘱总数（个）" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="center" width="200" fieldorder="" is_href="ipc.chart.chart.BB01_1_1" app_field="" datatype="template"><s:textfield readonly="true" name="sortname_shl" value="$[sortname_shl]"  fdtype="字符" format="" dictionary="" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="textfield" align="center" width="200" fieldorder="" is_href="ipc.chart.chart.BB01_1_1" app_field="">null</s:textfield>
</s:table.field>
<s:table.field name="sortname_bl" value="${empty sortname_bl ? '' : sortname_bl}" fdtype="字符" format="" dictionary="" label="问题医嘱比例（%）" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="center" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:tabpanel>
</s:row>
