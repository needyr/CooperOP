...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB04_5_1" init-action="" description="点评不合格科室[更多]->科室名称->不合格分类" system_product_code="ipc" title="点评不合格科室[更多]->科室名称->不合格分类" remark="点评不合格科室[更多]->科室名称->不合格分类" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB04_5_1", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB04_5_1", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB04_5_1", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB04_5_1", null);
	}
...
<s:row><s:table label="点评不合格科室[更多]->科室名称->不合格分类" cols="4" color="grey-silver" isdesign_="Y" tableid="03" icon="" djselect="ipc.chart.chart.BB04_5_1_1" subpage_name="点评不合格科室[更多]->科室名称->不合格分类->医生姓名" autoload="true" sort="false" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="comment_jiancheng" value="${empty comment_jiancheng ? '' : comment_jiancheng}" fdtype="字符" format="" dictionary="" label="不合格分类" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
...
<s:table.field name="bgfl" value="${empty bgfl ? '' : bgfl}" fdtype="实数" format="" dictionary="" label="不规范率" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:row>
</s:page>
