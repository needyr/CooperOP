...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB01_4" init-action="" description="审查不合格药品[更多]->药品" system_product_code="ipc" title="审查不合格药品[更多]➩药品" remark="审查不合格药品[更多]➩药品" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB01_4", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB01_4", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB01_4", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB01_4", null);
	}
...
<s:row type="frow"><s:textfield label="工作站分类" cols="1" name="d_tpye" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="50" precision="">${empty d_tpye ? '' : d_tpye}</s:textfield>
...
<s:row><s:tabpanel color="grey-silver" cols="4"><s:table label="审查不合格药品[更多]➩药品" cols="4" color="grey-silver" active="true" isdesign_="Y" tableid="01" icon="glyphicon glyphicon-sort-by-attributes" autoload="true" toIndex="0" sort="true" myIndex="0" djselect="ipc.chart.chart.BB01_4_1" subpage_name="审查不合格药品[更多]➩药品[:drug_name]➩科室" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="drug_name" value="${empty drug_name ? '' : drug_name}" fdtype="字符" format="" dictionary="" label="药品名称" size="128" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="300" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="用法用量" value="${empty 用法用量 ? '' : 用法用量}" fdtype="实数	" format="" dictionary="" label="用法用量" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="溶媒问题l" value="${empty 溶媒问题l ? '' : 溶媒问题l}" fdtype="实数	" format="" dictionary="" label="溶媒问题" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="给药途径" value="${empty 给药途径 ? '' : 给药途径}" fdtype="实数	" format="" dictionary="" label="给药途径" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="配伍禁忌" value="${empty 配伍禁忌 ? '' : 配伍禁忌}" fdtype="实数	" format="" dictionary="" label="配伍禁忌" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="相互作用" value="${empty 相互作用 ? '' : 相互作用}" fdtype="实数	" format="" dictionary="" label="相互作用" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="适应症" value="${empty 适应症 ? '' : 适应症}" fdtype="实数	" format="" dictionary="" label="适应症" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="禁忌症" value="${empty 禁忌症 ? '' : 禁忌症}" fdtype="实数	" format="" dictionary="" label="禁忌症" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="儿童老年人用药" value="${empty 儿童老年人用药 ? '' : 儿童老年人用药}" fdtype="实数	" format="" dictionary="" label="儿童老年人用药" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="病生理状" value="${empty 病生理状 ? '' : 病生理状}" fdtype="实数	" format="" dictionary="" label="病生理状" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="重复用药" value="${empty 重复用药 ? '' : 重复用药}" fdtype="实数	" format="" dictionary="" label="重复用药" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="医保" value="${empty 医保 ? '' : 医保}" fdtype="实数	" format="" dictionary="" label="医保" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="超级使用" value="${empty 超级使用 ? '' : 超级使用}" fdtype="实数	" format="" dictionary="" label="超级使用" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="无正当理由用药" value="${empty 无正当理由用药 ? '' : 无正当理由用药}" fdtype="实数	" format="" dictionary="" label="无正当理由用药" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="跨性别用药" value="${empty 跨性别用药 ? '' : 跨性别用药}" fdtype="实数	" format="" dictionary="" label="跨性别用药" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="药品使用问题" value="${empty 药品使用问题 ? '' : 药品使用问题}" fdtype="实数	" format="" dictionary="" label="药品使用问题" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="处方使用问题" value="${empty 处方使用问题 ? '' : 处方使用问题}" fdtype="实数	" format="" dictionary="" label="处方使用问题" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="其它" value="${empty 其它 ? '' : 其它}" fdtype="实数	" format="" dictionary="" label="其它" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="drug_code" value="${empty drug_code ? '' : drug_code}" fdtype="字符" format="" dictionary="" label="药品代码" size="32" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="60" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:tabpanel>
</s:row>
