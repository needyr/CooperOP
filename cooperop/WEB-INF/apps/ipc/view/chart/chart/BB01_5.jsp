...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB01_5" init-action="" description="审查不合理科室[更多]->科室" system_product_code="ipc" title="审查不合理科室[更多]➩科室" remark="审查不合理科室[更多]➩科室" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB01_5", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB01_5", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB01_5", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB01_5", null);
	}
...
<s:row><s:form label="审查不合理科室[更多]➩科室" icon="fa fa-list-alt" color="grey-silver" border="1" cols="4" istoorbar="Y"><s:row type="frow"><s:textfield label="审查类型" cols="1" name="sort_name" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="50" precision="">${empty sort_name ? '' : sort_name}</s:textfield>
...
<s:row ishidden="ishidden"><s:form label="表单" icon="fa fa-list-alt" color="grey-silver" border="1" cols="4"><s:row type="frow"><s:datefield label="截止时间" cols="1" name="end_date" value="${empty end_date ? rq : end_date}" placeholder="" fdtype="字符" defaultValue="${rq}" format="" nextfocusfield="" islabel="否" readonly="true" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="" out_action="" tableid="" expressions="" maxlength="10" precision=""></s:datefield>
...
<s:row><s:tabpanel color="grey-silver" cols="4"><s:table label="审查不合理科室[更多]➩科室" cols="4" color="grey-silver" active="true" isdesign_="Y" tableid="01" icon="glyphicon glyphicon-sort-by-attributes" autoload="true" toIndex="0" sort="false" myIndex="0" djselect="ipc.chart.chart.BB01_5_1" subpage_name="审查不合理科室[更多]➩[:dept_name]➩医生" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="dept_name" value="${empty dept_name ? '' : dept_name}" fdtype="字符" format="" dictionary="" label="科室名称" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="center" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
...
<s:table.field name="dept_shl" value="${empty dept_shl ? '' : dept_shl}" fdtype="字符" format="" dictionary="" label="问题医嘱总数（个）" size="50" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="center" width="200" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dept_BL" value="$[dept_bl]"  fdtype="实数" format="" dictionary="" label="问题医嘱比例（%）" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="textfield" align="right" width="200" fieldorder="" is_href="" app_field="" datatype="template"><s:textfield readonly="true" name="dept_BL" value="$[dept_bl]"  fdtype="实数" format="" dictionary="" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="textfield" align="right" width="200" fieldorder="" is_href="" app_field="">null</s:textfield>
</s:table.field>
<s:table.field name="dept_code" value="${empty dept_code ? '' : dept_code}" fdtype="字符" format="" dictionary="" label="科室代码" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="150" fieldorder="" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
</s:tabpanel>
</s:row>
