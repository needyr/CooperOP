...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="BB01_5_1" init-action="" description="审查不合格科室[更多]->科室->医生" system_product_code="ipc" title="审查不合格科室[更多]➩科室➩医生" remark="审查不合格科室[更多]➩科室➩医生" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("ipc.chart.chart.BB01_5_1", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("ipc.chart.chart.BB01_5_1", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "ipc.chart.chart.BB01_5_1", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("ipc.chart.chart.BB01_5_1", null);
	}
...
<s:table.field name="doctor_shl" value="${empty doctor_shl ? '' : doctor_shl}" fdtype="实数	" format="" dictionary="" label="不合理数量" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="160" fieldorder="2" is_href="" app_field=""></s:table.field>
<s:table.field name="doctor_no" value="${empty doctor_no ? '' : doctor_no}" fdtype="字符" format="" dictionary="" label="医生编号" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="3" is_href="" app_field=""></s:table.field>
<s:table.field name="dept_code" value="${empty dept_code ? '' : dept_code}" fdtype="字符" format="" dictionary="" label="科室代码" size="128" maxlength_show="" digitsize="0" precision="" available="false" sort="true" controltype="" align="left" width="120" fieldorder="4" is_href="" app_field="" hidden="true"></s:table.field>
</s:table.fields>
</s:table>
</s:tabpanel>
</s:row>
