...
import cn.crtech.cooperop.oa.dao.WorkdayTimeplanDao;
 ...
 * @date: 2019年10月25日
 */
public class WorkdayTimeplanService extends BaseService {
    public Result query(Map<String, Object> params) throws Exception {
	try {
	    connect();
	    WorkdayTimeplanDao dao = new WorkdayTimeplanDao();
