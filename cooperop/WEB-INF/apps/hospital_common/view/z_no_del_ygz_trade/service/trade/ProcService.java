...
import cn.crtech.cooperop.hospital_common.dao.trade.ProcDao;
...
public class ProcService extends BaseService{
	...
	public Result query(Map<String, Object> params) throws Exception {
		try {
			...
			return new ProcDao().query(params);
		} catch (Exception e) {
			throw e;
		}finally {
			disconnect();
