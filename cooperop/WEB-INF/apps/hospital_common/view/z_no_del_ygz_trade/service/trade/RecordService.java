...
import cn.crtech.cooperop.hospital_common.dao.trade.RecordDao;
...
public class RecordService extends BaseService{
	...
	public Result query(Map<String, Object> params) throws Exception {
		try {
			...
			return new RecordDao().query(params);
		} catch (Exception e) {
			throw e;
		}finally {
			disconnect();
	...
	public Record get(Map<String, Object> params) throws Exception {
		try {
			connect("data_transfer");
			return new RecordDao().get(params);
		} catch (Exception e) {
			throw e;
		}finally {
			disconnect();
