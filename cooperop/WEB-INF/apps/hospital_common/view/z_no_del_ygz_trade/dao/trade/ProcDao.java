...
public class ProcDao extends BaseDao{

	public static final String TABLE_NAME = "trade_db_proc";
	...
	public Result query(Map<String, Object> params) throws Exception {
		...
		if(!CommonFun.isNe(params.get("filter"))) {
			...
			sql.append(" and proc_code like :filter or proc_name like :filter or proc_name_cn like :filter or db_code like :filter ");
		}
	...
	public int update(Map<String, Object> params) throws Exception {
		Record r=new Record();
		r.put("proc_code", params.remove("proc_code"));
	...
	public Record get(Map<String, Object> params) throws Exception {
		...
		sql.append(" (nolock) where  proc_code = :proc_code ");
