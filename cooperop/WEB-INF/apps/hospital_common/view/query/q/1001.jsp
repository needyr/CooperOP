...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="1001" init-action="" description="测试" system_product_code="hospital_common" title="" remark="" flag="q" type="query"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("hospital_common.query.q.1001", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("hospital_common.query.q.1001", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "hospital_common.query.q.1001", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("hospital_common.query.q.1001", null);
	}
...
<s:row></s:row>
<s:row><s:table label="测试表格" cols="4" color="grey-silver" isdesign_="Y" tableid="678" icon="fa fa-bomb" djselect="" tablekey="" limit="10" height="" totals="" app_table="false" sort="true" autoload="true" istoorbar="Y" fitwidth="true" fields="" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="dept_code" fdtype="" format="" dictionary="" label="姓名" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
<s:table.field name="dept_NAME" fdtype="" format="" dictionary="" label="性别222" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="" is_href="" app_field=""></s:table.field>
