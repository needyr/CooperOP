...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="JCX019" init-action="" description="HIS药品字典" system_product_code="hospital_common" title="" remark="" flag="q" type="query"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("hospital_common.query.q.JCX019", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("hospital_common.query.q.JCX019", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "hospital_common.query.q.JCX019", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("hospital_common.query.q.JCX019", null);
	}
...
<s:table.field name="jixing" fdtype="字符" format="" dictionary="" label="剂型" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="6" is_href="" app_field=""></s:table.field>
<s:table.field name="usejlgg" fdtype="整数" format="" dictionary="" label="使用剂量" size="14" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="7" is_href="" app_field=""></s:table.field>
<s:table.field name="use_dw" fdtype="字符" format="" dictionary="" label="使用单位" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="8" is_href="" app_field=""></s:table.field>
<s:table.field name="input_code" fdtype="字符" format="" dictionary="" label="简称" size="100" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="9" is_href="" app_field=""></s:table.field>
<s:table.field name="sys_p_key" fdtype="字符" format="" dictionary="" label="标准库编号" size="100" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="10" is_href="" app_field=""></s:table.field>
<s:table.field name="property_toxi" fdtype="字符" format="" dictionary="" label="毒理分类" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="11" is_href="" app_field=""></s:table.field>
<s:table.field name="drug_indicator" fdtype="字符" format="" dictionary="" label="药品类别" size="128" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="12" is_href="" app_field=""></s:table.field>
<s:table.field name="pd_time" fdtype="字符" format="" dictionary="" label="配对时间" size="23" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="13" is_href="" app_field=""></s:table.field>
<s:table.field name="use_30day" fdtype="字符" format="" dictionary="" label="30天是否在用" size="100" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="14" is_href="" app_field=""></s:table.field>
</s:table.fields>
</s:table>
<s:table label="标准库药品信息" cols="4" color="grey-silver" active="false" isdesign_="Y" tableid="CX_02" icon="" djselect="" tablekey="" limit="10" toIndex="1" sort="true" autoload="false" istoorbar="Y" myIndex="1" fields="" app_table="false" height="" totals="" action="application.bill.queryTable"  select="multi" ><s:table.fields><s:table.field name="p_key" fdtype="字符" format="" dictionary="" label="序号" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="0" is_href="" app_field=""></s:table.field>
<s:table.field name="drug_code" fdtype="字符" format="" dictionary="" label="药品代码" size="32" maxlength_show="" digitsize="0" precision="" available="true" sort="true" controltype="" align="left" width="120" fieldorder="1" is_href="" app_field=""></s:table.field>
