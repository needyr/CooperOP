...
<s:page title="选择诊断" disloggedin="false">
<s:row>
<div class="top">
...
if('${param.code}'){
	var code = '${param.code}';
	$.call("hospital_common.dicthisdiagnosis.searchCheck",{code: code.split(',')},function(rtn){
		if(rtn.diagnosis){
			var html = [];
			var v = rtn.diagnosis;
...
function search1(){
	...
	if(data){
		$.call("hospital_common.dicthisdiagnosis.search",{data: data},function(rtn){
			if(rtn.diagnosis){
				var html = [];
				var v = rtn.diagnosis;
				for(i=0;i<v.length;i++){
