...
if('${param.code}'){
	...
	$.call("hospital_common.dictdrug.searchCheck",tj,function(rtn){
		if(rtn.drug){
			var html = [];
			var v = rtn.drug;
...
function search1(){
	...
	$.call("hospital_common.dictdrug.search",tj,function(rtn){
		if(rtn.drug){
			var html = [];
			var v = rtn.drug;
			for(i=0;i<v.length;i++){
			html.push('<tr class="is_c'+v[i].drug_code+'" data_id="'+v[i].drug_code+'">');
