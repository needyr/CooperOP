...
function caseHistory(){
	...
	//电子病历2
	var d_type = '${$return.patient.d_type}';
	var visit_id = '${$return.patient.visit_id}';
	var path = '';
	if(d_type == '1'){
		path = 'http://172.22.40.18:8280/emr-web/thisHospitalizationInfo/showView?userSysId=1&tsCheck=&hospitalId=341821&patInHosId='+visit_id.substring(visit_id.indexOf('_')+1,visit_id.length);

	}else if(d_type == '2' || d_type == '3'){
		path = 'http://172.22.40.18:9001/emr4/webEmrMzInfo.aspx?outpatcode='+'${$return.patient.patient_no}';
	}
