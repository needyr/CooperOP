...
<div class="bottom">	
<s:tabpanel>
<s:table id="datatable1" active="true" label="使用情况调查表" action="hospital_common.report.kjy.querykjyoutpuse" autoload="false" fitwidth="false">
<s:toolbar>
...
<s:table id="datatable2" limit="-1" label="(按科室)" action="hospital_common.report.kjy.querykjyoutpuse_dept" autoload="false" fitwidth="false">
<s:toolbar>
...
<s:table.fields>
	<s:table.field name="dept_name" datatype="string" label="科室" width="120"></s:table.field>
	<s:table.field name="all_drug_pz_num" datatype="string" label="医嘱累计用药总品种数(种)" width="220"></s:table.field>
	<s:table.field name="avg_all_drug_pz_num" datatype="script" label="平均用药品种数(种)" width="220">
		return (record.all_drug_pz_num/(record.patient_num+0.00)).toFixed(2);
	</s:table.field>
	<s:table.field name="all_drug_kjy_pz_num" datatype="string" label="医嘱累计抗菌药总品种数(种)" width="220"></s:table.field>
	<s:table.field name="bfb_all_drug_kjy_pz_num" datatype="script" label="累计抗菌药总品种数/累计用药总品种数" width="220">
		return (record.all_drug_kjy_pz_num/(record.all_drug_pz_num+0.00)).toFixed(2);
	</s:table.field>
	<s:table.field name="kjy_yizhu_num" datatype="string" label="抗菌药物医嘱数" width="220"></s:table.field>
	<s:table.field name="patient_num" datatype="string" label="医嘱总数" width="220"></s:table.field>
	<s:table.field name="bfb_kjy_yizhu_num" datatype="script" label="医嘱抗菌药物使用率%" width="220">
		return (record.kjy_yizhu_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="all_drug_money" datatype="string" label="药品总金额(元)" width="220"></s:table.field>
	<s:table.field name="avg_all_drug_money" datatype="script" label="药品平均金额(元)" width="220" >
		return (record.all_drug_money/(record.patient_num+0.00)).toFixed(2);
	</s:table.field>
	<s:table.field name="kjy_all_drug_money" datatype="string" label="抗菌药总金额(元)" width="220"></s:table.field>
	<s:table.field name="bfb_kjy_all_drug_money" datatype="script" label="抗菌药总额占药品总额比率%" width="220">
		return (record.kjy_all_drug_money/(record.all_drug_money+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="patient_use_kjy_money" datatype="string" label="使用抗菌药物医嘱总金额(元)" width="220"></s:table.field>
	<s:table.field name="avg_patient_use_kjy_money" datatype="script" label="抗菌药医嘱平均金额(元)" width="220">
		return (record.patient_use_kjy_money/(record.patient_num+0.00)).toFixed(2);
	</s:table.field>
	<s:table.field name="one_kjy_num" datatype="string" label="单用抗菌药物医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_one_kjy_num" datatype="script" label="单用抗菌药物医嘱使用率%" width="220">
		return (record.one_kjy_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="two_drug_union_num" datatype="string" label="二联使用抗菌药医嘱数" width="220"></s:table.field>
	...
	<s:table.field name="three_drug_union_num" datatype="string" label="三联使用抗菌药医嘱数" width="220"></s:table.field>
	...
	<s:table.field name="other_drug_union_num" datatype="string" label="四联及以上使用抗菌药医嘱数" width="220"></s:table.field>
	...
	<s:table.field name="zhiliao_kjy_num" datatype="string" label="治疗使用抗菌药物医嘱数" width="220"></s:table.field>
	...
	<s:table.field name="yufang_kjy_num" datatype="string" label="预防使用抗菌药物医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_yufang_kjy_num" datatype="script" label="预防使用抗菌药物构成比%" width="220">
		return (record.yufang_kjy_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="yufang_kjy_money" datatype="string" label="治疗使用抗菌药物总金额(元)" width="220"></s:table.field>
	<s:table.field name="bfb_yufang_kjy_money" datatype="script" label="治疗使用抗菌药物总额占抗菌药总额%" width="220" >
		return (record.yufang_kjy_money/(record.kjy_all_drug_money+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="zhiliao_kjy_money" datatype="string" label="预防使用抗菌药物总金额(元)" width="220"></s:table.field>
	<s:table.field name="bfb_zhiliao_kjy_money" datatype="script" label="预防使用抗菌药物总额占抗菌药总额%" width="220">
		return (record.zhiliao_kjy_money/(record.kjy_all_drug_money+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="avg_all_drug_kjy_pz_num" datatype="script" label="医嘱平均使用抗菌药品种数(种)" width="220">
		return (record.all_drug_kjy_pz_num/(record.patient_num+0.00)).toFixed(2);
	</s:table.field>
	<s:table.field name="kjy_ts_yizhu_num" datatype="string" label="使用特殊抗菌药医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_kjy_ts_yizhu_num" datatype="script" label="特殊抗菌药使用率%" width="220">
		return (record.kjy_ts_yizhu_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="kjy_xz_yizhu_num" datatype="string" label="使用限制抗菌药医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_kjy_xz_yizhu_num" datatype="script" label="限制抗菌药使用率%" width="220">
		return (record.kjy_xz_yizhu_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="kjy_fxz_yizhu_num" datatype="string" label="使用非限制抗菌药医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_kjy_fxz_yizhu_num" datatype="script" label="非限制抗菌药使用率%" width="220">
		return (record.kjy_fxz_yizhu_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="kjy_jmzs_yizhu_num" datatype="string" label="抗菌药静脉输液医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_kjy_jmzs_yizhu_num" datatype="script" label="抗菌药静脉输液医嘱比率%" width="220">
		return (record.kjy_jmzs_yizhu_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
</s:table.fields>
</s:table>

<s:table id="datatable3" limit="-1" label="(按医生)" action="hospital_common.report.kjy.querykjyoutpuse_doctor" autoload="false" fitwidth="false">
<s:toolbar>
...
<s:table.fields>
	...
	<s:table.field name="two_drug_union_num" datatype="string" label="二联使用抗菌药医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_two_drug_union_num" datatype="script" label="二联使用抗菌药医嘱使用率%" width="220">
		return (record.two_drug_union_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="three_drug_union_num" datatype="string" label="三联使用抗菌药医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_three_drug_union_num" datatype="script" label="三联使用抗菌药医嘱使用率%" width="220">
		return (record.three_drug_union_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="other_drug_union_num" datatype="string" label="四联及以上使用抗菌药医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_other_drug_union_num" datatype="script" label="四联及以上使用抗菌药医嘱使用率%" width="220">
		return (record.other_drug_union_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="zhiliao_kjy_num" datatype="string" label="治疗使用抗菌药物医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_zhiliao_kjy_num" datatype="script" label="治疗使用抗菌药物构成比%" width="220">
		return (record.zhiliao_kjy_num/(record.patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="yufang_kjy_num" datatype="string" label="预防使用抗菌药物医嘱数" width="220"></s:table.field>
	<s:table.field name="bfb_yufang_kjy_num" datatype="script" label="预防使用抗菌药物构成比%" width="220">
