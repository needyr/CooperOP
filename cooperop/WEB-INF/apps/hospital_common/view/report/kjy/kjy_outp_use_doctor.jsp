...
<div class="bottom">
<s:table id="datatable3" limit="-1" label="门(急)诊处方抗菌药物使用情况(按医生)" action="hospital_common.report.kjy.querykjyomj_doctor" autoload="false" fitwidth="false" >
<s:toolbar>
...
<s:table.fields>
	<s:table.field name="doctor_name" datatype="string" label="医生名称" ></s:table.field>
	<s:table.field name="doctor_dept_name" datatype="string" label="医生科室" ></s:table.field>
	...
	<s:table.field name="patient_use_kjy_money" datatype="string" label="使用抗菌药物处方总金额(元)" ></s:table.field>
	<s:table.field name="avg_patient_use_kjy_money" datatype="script" label="抗菌药处方平均金额(元)" >
	...
	<s:table.field name="other_drug_union_num" datatype="string" label="四联及以上使用抗菌药处方数" ></s:table.field>
	<s:table.field name="bfb_other_drug_union_num" datatype="script" label="四联及以上使用抗菌药处方使用率%" >
