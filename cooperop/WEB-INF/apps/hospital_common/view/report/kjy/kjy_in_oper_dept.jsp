...
<div class="bottom">
<s:table id="datatable1" limit="-1" active="true" label="使用情况调查表" action="hospital_common.report.kjy.querykjyoper_dept" autoload="false" fitwidth="true">
<s:toolbar>
...
<s:table.fields>
	<s:table.field name="dept_code" datatype="string" label="科室编码" width="80"></s:table.field>
