...
<div class="bottom">
<s:table id="datatable1" limit="-1" active="true" label="使用情况调查表" action="hospital_common.report.kjy.querykjyoper_doctor" autoload="false" fitwidth="true">
<s:toolbar>
...
<s:table.fields>
	<s:table.field name="attending_doctor_code" datatype="string" label="工号" width="80"></s:table.field>
	<s:table.field name="attending_doctor" datatype="string" label="医生名称" width="80"></s:table.field>
	<s:table.field name="dept_name" datatype="string" label="科室名称" width="80"></s:table.field>
	<s:table.field name="oper_patient_num" datatype="string" label="手术例数(例)" width="80"></s:table.field>
	<s:table.field name="yf_kjy_patient_num" datatype="string" label="预防用抗菌药物的手术例数(例)"  width="80"></s:table.field>
	<s:table.field name="bfb_yf_kjy_patient_num" datatype="script" label="手术预防用抗菌药物百分率(%)"  width="80">
		return ((record.yf_kjy_patient_num+0.00)/(record.oper_patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="time_num" datatype="string" label="手术前0.5-2.0小时给药例数(例)"  width="80"></s:table.field>
	<s:table.field name="bfb_time_num" datatype="script" label="手术前0.5-2.0小时内给药百分率(%)"  width="80">
		return ((record.time_num+0.00)/(record.oper_patient_num+0.00)*100).toFixed(2);
	</s:table.field>
	<s:table.field name="use_time" datatype="script" label="预防用抗菌药物总天数(天)"  width="80">
		return record.use_time?record.use_time:0;
	</s:table.field>
	<s:table.field name="avg_use_time" datatype="script" label="预防用抗菌药物平均用药天数(天)"  width="80">
		return ((record.use_time?record.use_time:0)/(record.oper_patient_num+0.00)).toFixed(2);
	</s:table.field>
	<s:table.field name="not24_num" datatype="string" label="预防使用抗菌药物时间不超过24小时手术例数(例)"  width="80"></s:table.field>
	<s:table.field name="bfb_not24_num" datatype="script" label="预防使用抗菌药物时间不超过24小时的百分率(%)"  width="80">
		return (record.yf_kjy_patient_num == 0)?0.00:((record.not24_num+0.00)/(record.yf_kjy_patient_num+0.00)*100).toFixed(2);
	</s:table.field>
</s:table.fields>
</s:table>
