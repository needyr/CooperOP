...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">医生药品使用例次汇总排名表</span>
...
function query1(){
	...
	$.call('hospital_common.report.drug_amount_patient.query_doctor',data,function(rtn){
		var real_re = [];
		if(rtn.count>0){
		...
		var data_cols1 = [];
		var data_cols2 = [];
		data_cols1.push({field:'rowid', title:'排名(例次)', width:100, rowspan: 2});
		...
		for(var i = 1;i <= +cxtj.dept_pm;i++){
			data_cols2.push({field:'kz_'+i, title:'医生'+i+'(例次)'});
		}
