...
<s:page title="医生门(急)诊处方药品金额超过N元清单">
<!-- <div class="top"> -->
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">医生门(急)诊处方药品金额超过N元清单</span>
...
function query1(){
	...
	$.call('hospital_common.report.drug_amount_exceed.query_doctor',data,function(rtn){
		var real_re = [];
		if(rtn.count>0){
			var range_zong = 0;
