...
<s:page title="门(急)诊处方药品金额超过N元清单">
<!-- <div class="top"> -->
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">门(急)诊处方药品金额超过N元清单</span>
...
function create_table1(real_re){
	cols1 = [[
	    ...
	    ,{field:'drug_money', title:'处方药品金额(元)',sort:true}
...
function query1(){
	...
	$.call('hospital_common.report.drug_amount_exceed.query_stats',data,function(rtn){
		var real_re = [];
		if(rtn.count>0){
			...
			for(var i=0;i<res.length;i++){
				...
				if(res.length - 1 == i){
					...
					real_re.push({'rowid':'处方药品金额：≥'+ cxtj.range + '元的处方总数：'+rtn.count+'张'});
				}
			}
		}
