...
<div class="bottom">	
<s:table id="datatable1" limit="-1" active="true" label="病人药品费用构成统计表" action="hospital_common.report.drug_use.query_stats" autoload="false" fitwidth="true">
<s:toolbar>
...
<s:table.fields>
	<s:table.field name="total" label="统计项目" datatype="" width=""></s:table.field>
	<s:table.field name="result" label="结果"  datatype="decimal" format="##0.00"></s:table.field>
	<s:table.field name="avg" label="统计项目" width=""></s:table.field>
	<s:table.field name="result2" label="结果" datatype="decimal" format="##0.00"></s:table.field>
</s:table.fields>
</s:table>
