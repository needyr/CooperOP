...
<div class="bottom">	
<s:table id="datatable1" limit="-1" sort="true" active="true" label="医生病人药品费用构成统计表" action="hospital_common.report.drug_use.query_doctor" autoload="false" fitwidth="false">
<s:toolbar>
...
<s:table.fields>
	<s:table.field name="attending_doctor" label="医生"	datatype="script" >
		return record.attending_doctor?record.attending_doctor:'未知医生';
	</s:table.field>
