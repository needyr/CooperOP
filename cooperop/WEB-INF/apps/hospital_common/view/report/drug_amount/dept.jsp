...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">科室药品使用金额及数量排名表</span>
...
function query1(){
	...
	$.call('hospital_common.report.drug_amount.query_dept',data,function(rtn){
		var real_re = [];
		if(rtn.count>0){
		...
		for(var i = 1;i <= +cxtj.dept_pm;i++){
			data_cols2.push({field:'kz_'+i, title:'科室'+i+'('+xs_pmfs+')'});
		}
