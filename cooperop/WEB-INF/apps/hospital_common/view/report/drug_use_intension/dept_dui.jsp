...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">科室药品使用强度统计表</span>
...
var cols1 = [[
	{field:'dept_name', title:'科室名称', width:120}
	,{field:'all_patient', title:'同期收治患者人数(人)', width:180}
	,{field:'all_patient_ts', title:'同期收治患者人天数(天)', width:180}
    ...
    ,{field:'sylc', title:'使用例次', width:120}
    ...
    ,{field:'_data1', title:'占药科室物类总额比例(%)', width:200,templet: function(record){
        return (Number(record.kind_drug_num)/Number(record.all_drug_money)*100 || 0).toFixed(2);
    }}
    ,{field:'_data2', title:'占科室药品总金额比例(%)', width:200,templet: function(record){
	...
	layui.use('table', function(){
	  ...
	  var ins1 = table.render({
	    ...
	    ,done : function(res, curr, count) {
	    	merge(res,['dept_name','all_patient','all_patient_ts'],[0,1,2]);
...
function query1(){
	...
	$.call('hospital_common.report.drug_use_intension.query_dept_dui',data,function(rtn){
		var real_re = [];
		if(rtn.count>0){
