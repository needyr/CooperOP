...
<s:page title="科室药品消耗情况及使用量(DDDs)汇总统计表">
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">科室药品消耗情况及使用量(DDDs)汇总统计表</span>
...
var cols1 = [[
	{field:'dept_name', title:'科室名称', rowspan: 2}
...
function query1(){
	...
	$.call('hospital_common.report.drug_use_intension.query_expend_dept_zj',data,function(rtn){
		var real_re = [];
		if(rtn.count>0){
