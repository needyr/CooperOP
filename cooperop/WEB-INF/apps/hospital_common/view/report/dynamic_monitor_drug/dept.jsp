...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">科室药品动态监测排名表</span>
...
function query1(){
	...
	$.call('hospital_common.report.dynamic_monitor_drug.query_dept',data,function(rtn){
		var real_re = [];
		...
		data_cols1.push({field:'dept_name', title:'科室名称', rowspan: 2});
		if(cxtj.time_unit == '0'){
