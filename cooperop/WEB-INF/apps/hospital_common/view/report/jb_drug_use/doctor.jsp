...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">医生基本药物使用情况统计表</span>
...
function create_table1(real_re){
	cols1 = [[
	    ...
	    ,{field:'attending_doctor_dept', title:'医生科室'}
...
function query1(){
	...
	$.call('hospital_common.report.jb_drug_use.query_doctor',data,function(rtn){
		var real_re = [];
		if(rtn.count>0){
