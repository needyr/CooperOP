...
<s:page title="科室门(急)诊处方药品品种超过N种清单">
<!-- <div class="top"> -->
...
<script type="text/html" id="toolbarDemo">
  <div class="layui-btn-container">
    <span style="font-size:14px">科室门(急)诊处方药品品种超过N种清单</span>
...
function query1(){
	...
	$.call('hospital_common.report.drug_kind_exceed.query_dept',data,function(rtn){
		var real_re = [];
		if(rtn.count>0){
			var range_zong = 0;
