...
<s:table action="hospital_common.guide.verify.queryQuestion" limit="-1" sort="true" fitwidth="true" label="日志查看"  id="datatable">
	...
	<s:table.fields>
		...
		<s:table.field name="msg" label="信息"  ></s:table.field>
		<s:table.field name="i_table_name" label="主表" ></s:table.field>
		<s:table.field name="i_field" label="主表字段" ></s:table.field>
		<s:table.field name="c_table_name" label="联合表" ></s:table.field>
		<s:table.field name="c_field" label="联合表字段" ></s:table.field>
		...
		<s:table.field name="caozuo" label="操作" datatype="script" width="100px" >
			if(record.is_deal == 1){
				return '';
			}else{
...
<script type="text/javascript">
			...
			if(r && r.verify_thread2){
				...
				var ii = setInterval(function(){
					$.call('hospital_common.guide.verify.getBar',{},function(rtn){
						if(rtn && rtn.verify_thread2){
							if(rtn.data2_bar){
								i = rtn.data2_bar
							}
							if(rtn.data2){
								$('.bar-box .progress-tips-bar .tips').text('正在校验表: ' + rtn.data2)
							}
						}else{
							i = 100;
						}
	...
	function start(){
		$.call('hospital_common.guide.verify.queryQuestion',{master_bh:2,is_deal:0},function(rtn){
			if(rtn && rtn.count > 0){
				...
				$.call('hospital_common.guide.flow.execVerify',{master_bh:"2"},function(rtn){
					var ii = setInterval(function(){
						$.call('hospital_common.guide.verify.getBar',{},function(rtn){
							if(rtn && rtn.verify_thread2){
								if(rtn.data2_bar){
	...
	function getState(){
		$.call('hospital_common.guide.verify.getState',{master_bh:2},function(rtn){
			if(rtn == 0){
				$('.caption').text('请进行校验');
