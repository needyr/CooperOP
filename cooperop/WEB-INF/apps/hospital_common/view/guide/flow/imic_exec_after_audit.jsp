...
<div class="page-wrap">
	<div class="column-default" style="min-height: 300px;width: 100%;height:100%;">
		<ul class="large-btn">
			<li><a href="#" onclick="start();"><i class="icon-hourglass"></i>执行【医保控费】事后审查</a></li>
...
<script type="text/javascript">
	...
	function start(){
	  $.call('hospital_common.guide.flow.execOneAfterAudit',{flow_id:'${param.id}',exec_pro:'JCR_after_imic_audit_discharge'},function(rtn){
			$.message('执行成功!');
