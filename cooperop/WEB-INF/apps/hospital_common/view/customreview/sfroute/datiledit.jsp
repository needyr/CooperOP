	...
	<s:row>
		<s:form id="form" label="用法问题">
			...
			<s:row>
				...
				<s:textfield label="年龄段" name="nianl_c"  cols="1" disabled="disabled" value="${nianl_c}" dbl_action='zl_select_shengfrt_06,shengfangzl_routename'></s:textfield>
			...
			<s:row>
				...
				<s:textfield label="项目编号" name="xmmch"  cols="1" disabled="disabled" value="${xmmch}" dbl_action='zl_select_shengfrt_02,shengfangzl_routename'></s:textfield>
				<%-- <s:textfield label="项目名称" disabled="disabled" name="xmmch"  cols="1" value="${xmmch}"></s:textfield> --%>
				<s:textfield label="公式"  disabled="disabled" name="formul"  cols="1" value="${formul_name}" dbl_action='zl_select_shengfrt_03,shengfangzl_routename'></s:textfield>
				<s:textfield label="值" name="value"  cols="1"  value="${value}"     dbl_action='zl_select_shengfrt_01,shengfangzl_routename'></s:textfield>
			</s:row>
			<%-- <s:row>
...
<script type="text/javascript">
	...
	function save(){
		...
		if (patrn.test(str)) {// 如果包含特殊字符
			...
			$.call("hospital_common.customreview.sfroute.save",sdata,function(s){
				$.closeModal(s);
	    	});
			if(sdata.id){
