...
<script type="text/javascript">
	$(function(){
		$(window).resize(function(){
			$('.dataTables_scrollBody').css('height',window.innerHeight - 250);
	...
	function query(){
		...
		qdata.codes = '[{"code":"hospital_name","system_product_code":"hospital_common"}'
			+ ',{"code":"hospital_id","system_product_code":"hospital_common"}'
			+ ',{"code":"HOSPITAL_LEVEL","system_product_code":"hospital_common"}'
            + ',{"code":"HOSPITAL_DJ","system_product_code":"hospital_common"}'
			+ ']';
	...
	function update(code){
		if(code == 'time_pharmacist_work' || 
			...
			$.modal("worktimeedit.html","修改配置",{
				...
				height:"70%",
				code:code,
				system_product_code:'hospital_common',
				callback : function(e){
					if(e){
						query();
					}
