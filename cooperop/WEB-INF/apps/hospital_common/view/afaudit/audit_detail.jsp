					...
					<div class="boc-list">
						<div class="box-list" id="question_${mr.sort_id}" >
				            ...
				            <p id="dorctor_comment">
				             ...
				             <p>结果：<b style="color: #a50606; font-size: 16px;">${mr.description}</b></p>
	...
	//ipc查看详情
	 function seeopen(check_result_info_id,sort_id){
		 layer.open({
			  ...
			  area: ['910px', '550px'], 
			  content: "/w/ipc/auditresult/particulars_lishi.html?auto_audit_id=${$return.ipc.ipc_auto_id}&&sort_id="+sort_id+"&&check_result_info_id="+check_result_info_id+"#topsta"
		}); 
	} 
