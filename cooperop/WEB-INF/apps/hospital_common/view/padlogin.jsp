...
<%
	...
	if (!CommonFun.isNe(welcome_page) && !"/login.jsp".equals(welcome_page) && !url.endsWith("/login.jsp")) {
...
<script>
	...
	var submitMe = function() {
		...
		$.getJSON("http://192.168.1.124:8080/w/application.auth.login.jsonp?callback=?", da, 
			    function(rtn) {
					if (rtn.emsg) {
						...
						var url = "http://192.168.1.124:8080/"+rtn.redirect_url;
