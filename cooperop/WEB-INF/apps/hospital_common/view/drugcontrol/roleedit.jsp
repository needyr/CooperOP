...
<s:page title="编辑信息" ismodal="true"  disloggedin="true">
	<s:row>
		<s:form id="form" label="编辑角色用药规则信息">
			<s:toolbar>
			...
			<s:row>
				...
				<input type="hidden" name="item" value="role" title="角色">
				<input type="hidden" name="paramcode" value="${value}">
				<s:textfield cols="3" required="true" id="value_id" name="value" label="值" value="${value_name}"   placeholder="单击选择角色"></s:textfield>
			</s:row>
			<s:row>
...
$('[name=value]').click(function(){
	...
	$.modal("/w/ipc/sample/choose/role.html", "添加角色", {
		height: "550px",
		width: "50%",
		code: code,
		maxmin: false,
