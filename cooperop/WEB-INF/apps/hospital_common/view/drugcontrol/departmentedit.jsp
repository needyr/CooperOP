...
<s:page title="编辑信息" ismodal="true"  disloggedin="true">
	<s:row>
		<s:form id="form" label="编辑科室用药规则信息">
			<s:toolbar>
			...
			<s:row>
				...
				<input type="hidden" name="item" value="department" title="科室">
				<input type="hidden" name="paramcode" value="${value}">
				<s:textfield cols="3" required="true"  id="value_id" name="value" label="值" value="${value_name}"  placeholder="单击选择科室"></s:textfield>
			</s:row>
			<s:row>
