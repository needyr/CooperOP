...
<s:page title="编辑信息" ismodal="true"  disloggedin="true">
	<s:row>
		<s:form id="form" label="编辑医生用药规则信息">
			<s:toolbar>
			...
			<s:row>
				...
				<input type="hidden" name="item" value="doctor" title="医生">
				<input type="hidden" name="paramcode" value="${value}">
				<s:textfield cols="3" required="true"  id="value_id" name="value" label="值" value="${value_name}"   placeholder="单击选择医生"></s:textfield>
			</s:row>
			<s:row>
