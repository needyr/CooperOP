...
import cn.crtech.cooperop.hospital_common.service.syscustomreview.SysSfRongmService;

public class SyssfrongmAction extends BaseAction{

	public Result query(Map<String, Object> params) throws Exception {
		
		return new SysSfRongmService().query(params);
	}
	
	public int insert(Map<String, Object> params) throws Exception {
		
		return new SysSfRongmService().insert(params);
	}
	...
	public int save(Map<String, Object> params) throws Exception {
		...
		if(CommonFun.isNe(params.get("id"))){
			...
			return new SysSfRongmService().update(params);
		}
}
	
	public int delete(Map<String, Object> params) throws Exception {
		
		return new SysSfRongmService().delete(params);
	}
	
	public Record datiledit(Map<String, Object> params) throws Exception {
		
		if(!CommonFun.isNe(params.get("id"))){
			return new SysSfRongmService().get(params);
		}else {
			return null;
		}
	}
