...
import cn.crtech.cooperop.hospital_common.dao.report.Drug_kindDao;

public class Drug_kindService extends BaseService {

	public Result query_stats(Map<String, Object> params) throws Exception {
		try {
			connect("hospital_common");
			return new Drug_kindDao().query_stats(params);
		} catch (Exception e) {
			throw e;
		}
		finally {
	...
	public Result query_dept(Map<String, Object> params) throws Exception {
		try {
			connect("hospital_common");
			return new Drug_kindDao().query_dept(params);
		} catch (Exception e) {
			throw e;
		}
		finally {
	...
	public Result query_doctor(Map<String, Object> params) throws Exception {
		try {
			connect("hospital_common");
			return new Drug_kindDao().query_doctor(params);
		} catch (Exception e) {
			throw e;
		}
		finally {
