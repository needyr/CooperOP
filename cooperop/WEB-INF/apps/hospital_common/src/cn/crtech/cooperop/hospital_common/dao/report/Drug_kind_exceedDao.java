...
public class Drug_kind_exceedDao extends BaseDao {
	...
	public Result query_stats(Map<String, Object> params) throws Exception {
		...
		sql.append(") a ");
		sql.append(" where a.drug_kind_num >= :range ");
	...
	public Result query_dept(Map<String, Object> params) throws Exception {
		...
		sql.append("(select count(1) from #ttt where a.dept_code=dept_code and drug_kind_num >= :range) as range_count ");
	...
	public Result query_doctor(Map<String, Object> params) throws Exception {
		...
		sql.append("(select count(1) from #ttt where a.ATTENDING_DOCTOR_code=ATTENDING_DOCTOR_code and drug_kind_num >= :range) as range_count ");
		sql.append("from #ttt2 a                       ");
	...
	/*params：{d_type=2,3, start_time=2021-03-26, obj=1,
	end_time=2021-03-26, range=1, d_type_name=门诊 ,急诊 }*/
	...
	public String getFields() {
		...
		sql.append("a.yufang_kjy_num,      ");
		sql.append("a.zhiliao_kjy_num,     ");
		sql.append("a.yufang_kjy_money,    ");
		sql.append("a.zhiliao_kjy_money,   ");
		sql.append("a.ts_kjy_num,          ");
		sql.append("a.ts_kjy_money,        ");
		sql.append("a.kjy_xz_num,          ");
		sql.append("a.kjy_xz_money,        ");
		sql.append("a.kjy_fxz_num,         ");
		sql.append("a.kjy_fxz_money,       ");
		sql.append("a.kjy_jmzs_num,        ");
		sql.append("a.kjy_jmzs_money       ");
		return sql.toString();
	}
