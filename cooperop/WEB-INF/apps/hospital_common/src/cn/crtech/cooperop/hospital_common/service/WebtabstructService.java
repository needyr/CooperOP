...
import cn.crtech.cooperop.hospital_common.dao.WebtabstructDao;
import cn.crtech.cooperop.bus.rdms.Result;

public class WebtabstructService extends BaseService{
	...
	public int insert(Map<String, Object> params) throws Exception{
		try{
			connect();
			int i = new WebtabstructDao().insert(params);
			return i;
		}catch(Exception ex){
			throw ex;
		}finally{
	...
	public List<Record> query(Map<String, Object> params) throws Exception{
		try{
			connect();
			Result rs = new WebtabstructDao().query(params);
	...
	public int modify(Map<String, Object> params) throws Exception {
		try {
			connect();
			return new WebtabstructDao().modify(params);
		} finally {
			disconnect();
		}
	}
