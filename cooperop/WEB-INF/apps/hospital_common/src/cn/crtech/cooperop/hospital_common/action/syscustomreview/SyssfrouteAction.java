...
import cn.crtech.cooperop.hospital_common.service.syscustomreview.SysSfRouteService;

public class SyssfrouteAction extends BaseAction{

	public Result query(Map<String, Object> params) throws Exception {
		
		return new SysSfRouteService().query(params);
	}
	
	public int insert(Map<String, Object> params) throws Exception {
		
		return new SysSfRouteService().insert(params);
	}
	...
	public int save(Map<String, Object> params) throws Exception {
		...
		if(CommonFun.isNe(params.get("id"))){
			...
			return new SysSfRouteService().update(params);
		}
}
	
	public int delete(Map<String, Object> params) throws Exception {
		return new SysSfRouteService().delete(params);
	}
	
	public Record datiledit(Map<String, Object> params) throws Exception {
		
		if(!CommonFun.isNe(params.get("id"))){
			return new SysSfRouteService().get(params);
		}else {
			return null;
		}
	}
