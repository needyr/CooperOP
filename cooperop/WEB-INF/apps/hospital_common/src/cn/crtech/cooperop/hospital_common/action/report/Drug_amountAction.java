...
import cn.crtech.cooperop.hospital_common.service.report.Drug_amountService;

public class Drug_amountAction extends BaseAction {
	public Result query_stats(Map<String, Object> params) throws Exception {
		return new Drug_amountService().query_stats(params);
	}
	
	public Result query_dept(Map<String, Object> params) throws Exception {
		return new Drug_amountService().query_dept(params);
	}

	public Result query_doctor(Map<String, Object> params) throws Exception {
		return new Drug_amountService().query_doctor(params);
	}
