...
import cn.crtech.cooperop.hospital_common.service.syscustomreview.SysSfSyzService;

public class SyssfsyzAction extends BaseAction{

	public Result query(Map<String, Object> params) throws Exception {
		
		return new SysSfSyzService().query(params);
	}
	
	public int insert(Map<String, Object> params) throws Exception {
		
		return new SysSfSyzService().insert(params);
	}
	...
	public int save(Map<String, Object> params) throws Exception {
		...
		if(CommonFun.isNe(params.get("id"))){
			...
			return new SysSfSyzService().update(params);
		}
}
	
	public int delete(Map<String, Object> params) throws Exception {
		return new SysSfSyzService().delete(params);
	}
	
	public Record datiledit(Map<String, Object> params) throws Exception {
		
		if(!CommonFun.isNe(params.get("id"))){
			return new SysSfSyzService().get(params);
		}else {
			return null;
		}
	}
