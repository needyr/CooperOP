...
import cn.crtech.cooperop.hospital_common.service.imiccustomre.YbitemService;

public class YbitemAction extends BaseAction{

	public Result query(Map<String, Object> params) throws Exception {
		
		return new YbitemService().query(params);
	}
	...
	public int save(Map<String, Object> params) throws Exception {
		...
		if(CommonFun.isNe(params.get("id"))){
			params.remove("id");
			return new YbitemService().insert(params);
		}else{
			return new YbitemService().update(params);
		}
}
	
	public int delete(Map<String, Object> params) throws Exception {
		
		return new YbitemService().delete(params);
	}
	
	public Record datiledit(Map<String, Object> params) throws Exception {
		if(!CommonFun.isNe(params.get("id"))){
			return new YbitemService().get(params);
		}else {
			return null;
		}
	}
