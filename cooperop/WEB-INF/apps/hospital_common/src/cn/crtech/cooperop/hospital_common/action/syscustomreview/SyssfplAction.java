...
import cn.crtech.cooperop.hospital_common.service.syscustomreview.SysSfPLService;

public class SyssfplAction extends BaseAction{

	public Result query(Map<String, Object> params) throws Exception {
		
		return new SysSfPLService().query(params);
	}
	
	public int insert(Map<String, Object> params) throws Exception {
		return new SysSfPLService().insert(params);
	}
	...
	public int save(Map<String, Object> params) throws Exception {
		...
		if(CommonFun.isNe(params.get("id"))){
			...
			return new SysSfPLService().update(params);
		}
}
	
	public int delete(Map<String, Object> params) throws Exception {
		
		return new SysSfPLService().delete(params);
	}
	
	public Record datiledit(Map<String, Object> params) throws Exception {
		
		if(!CommonFun.isNe(params.get("id"))){
			return new SysSfPLService().get(params);
		}else {
			return null;
		}
	}
