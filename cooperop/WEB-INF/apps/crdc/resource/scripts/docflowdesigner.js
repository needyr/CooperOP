		...
		$this.onContextMenuClick = function(menu) {
			if (context_menu[0].menuObject instanceof Flow) {
				if (menu == "flowproperty") {
					...
					$.modal(cooperopcontextpath + "/w/crdc/docflow/flow.html", "流程属性", $.extend(true, data, {
						fields: $.toJSON(designer.page.getHZData()),
						pageattr: $.toJSON(designer.page.getData().attrs),
						//width: "640px",
						//height: "480px",
				...
				if (context_menu[0].menuObject.type.id != "start" && context_menu[0].menuObject.type.id != "end" && menu == "nodeproperty") {
					...
					$.modal(cooperopcontextpath + "/w/crdc/docflow/node.html", "节点属性 [" + t.name + "]", $.extend(true, data, {
						fields: $.toJSON(designer.page.getHZData()),
						pageattr: $.toJSON(designer.page.getData().attrs),
						type: t.type.id,
						//width: "640px",
				...
				if (menu == "routeproperty") {
					...
					$.modal(cooperopcontextpath + "/w/crdc/docflow/route.html", "流向属性 [" + t.fromNode.name + " -> " + t.toNode.name + "]", $.extend(true, data, {
						fields: $.toJSON(designer.page.getHZData()),
						pageattr: $.toJSON(designer.page.getData().attrs),
						//width: "640px",
						//height: "480px",
