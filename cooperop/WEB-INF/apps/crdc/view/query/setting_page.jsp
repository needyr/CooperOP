...
<s:row>
	<s:form fclass="portlet light bordered" id="setFrom">
		<s:row>
			...
			<s:textfield label="查询方案标识" name="schemeid" value="${pageParam.schemeid }" required="true" maxlength="16"></s:textfield>
			<s:textfield label="中文描述" name="description" value="${pageParam.description }" required="true"></s:textfield>
