...
<s:page title="流程设计器">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/res/crdc/css/ruleflowdesigner.css"></link>
<script type="text/javascript" src="${pageContext.request.contextPath}/res/crdc/scripts/ruleflowdesigner.js"></script>
	<div class="row">
		<div class="col-md-2">
				...
				<div class="portlet-body">
					<div class="panel-group accordion scrollable" id="accordion2">
						<ul class="list-group">
							...
							<li class="list-group-item" fnt="judge">
								<i class="fa fa-sitemap"></i>判断节点
							</li>
							<li class="list-group-item" fnt="auto">
								<i class="fa fa-cog"></i>规则节点
							</li>
