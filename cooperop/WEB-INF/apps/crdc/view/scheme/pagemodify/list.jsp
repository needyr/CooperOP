...
<s:row>
	...
	<s:row>
		<s:table color="green" label="页面修改方案" autoload="true" id="mytable"
			action="crdc.scheme.pagemodify.query" sort="true" fitwidth="true">
			<s:toolbar>
...
function query(){
	...
	function deleteFlow(fangabh,fangalx) {
		$.confirm("是否确认删除该方案？删除后将无法恢复！", function(c) {
			if (c) {
				$.call("crdc.scheme.pagemodify.delete", {
					fangabh:fangabh, 
					fangalx:fangalx
				}, function(rtn) {
					if(rtn=='Y'){
