...
<s:page ismodal="true" title="" dispermission="true">
	<s:row>
		<s:form id="setFrom">
			<s:row>
				<s:textfield label="字段名" name="name" value="${control.name }" dblaction="queryfields"></s:textfield>
			...
			<s:row>
				<s:textfield label="选中显示值" name="ontext" value="${control.ontext }"></s:textfield>
				<s:textfield label="取消显示值" name="offtext" value="${control.offtext }"></s:textfield>
			</s:row>
			<s:row>
				<s:textfield label="选中值" name="onvalue" value="${control.onvalue }"></s:textfield>
				<s:textfield label="取消值" name="offvalue" value="${control.offvalue }"></s:textfield>
				<s:textfield label="默认值" name="defaultValue"
