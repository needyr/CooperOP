	...
	<s:row>
		<s:form label="字段属性" id="setForm">
			<s:row>
				...
				<s:textfield label="显示宽度" name="maxlength_show" value="${pageParam.maxlength_show }"></s:textfield>
			...
			<s:row>
				<s:textfield cols="4" label="链接执行函数" name="is_href" value="${pageParam.is_href }" dblaction="queryschemes,${pageParam.schemeid },${pageParam.system_product_code }"/>
