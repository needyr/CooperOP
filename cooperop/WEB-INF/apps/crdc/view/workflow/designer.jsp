				...
				<div class="portlet-body">
					<div class="panel-group accordion scrollable" id="accordion2">
						<ul class="list-group">
							...
							<li class="list-group-item" fnt="state">
								<i class="fa fa-tag"></i>状态节点
							</li>
							<li class="list-group-item" fnt="auto">
								<i class="fa fa-cog"></i>自动节点
							</li>
							<li class="list-group-item" fnt="sub-process">
								<i class="fa fa-caret-square-o-right"></i>子任务
							</li>
...
$(document).ready(function() {
	$(window).resize(function() {
		$(".flowdesigner").height(document.body.clientHeight - $(".flowdesigner").offset().top - 100);
	});
	$(window).resize();
