...
public class SystemParamsDao extends BaseDao {
	private final static String TABLE_NAME = "system_params";
	
	public Result query(Map<String, Object> params) throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append("select f.* from " + TABLE_NAME+ " f ");
		sql.append(" where 1 = 1");
		if(!CommonFun.isNe(params.get("keyword"))){
			sql.append(" and type = :keyword");
		}
