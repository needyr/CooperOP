...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="DP_TJ01" init-action="" description="住院普通药品统计报表" system_product_code="hospital_oc" title="住院普通药品统计报表" remark="住院普通药品统计报表" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("hospital_oc.chart.chart.DP_TJ01", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("hospital_oc.chart.chart.DP_TJ01", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "hospital_oc.chart.chart.DP_TJ01", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("hospital_oc.chart.chart.DP_TJ01", null);
	}
...
<s:row type="frow"><s:textfield label="科室名称" cols="1" name="dept_name" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="zl_select_DP_TJ01_01" out_action="" tableid="" expressions="" maxlength="128" precision="">${empty dept_name ? '' : dept_name}</s:textfield>
</s:row>
...
<s:table.field name="drug_name" value="$[drug_name]"  fdtype="字符" format="" dictionary="" label="药品名称" size="128" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="textfield" align="left" width="250" fieldorder="1" is_href="hospital_common.additional.instruction" app_field="" datatype="template"><s:textfield readonly="true" name="drug_name" value="$[drug_name]"  fdtype="字符" format="" dictionary="" size="128" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="textfield" align="left" width="250" fieldorder="1" is_href="hospital_common.additional.instruction" app_field="">null</s:textfield>
</s:table.field>
