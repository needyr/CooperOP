...
<s:page ismodal="false" disloggedin="false" dispermission="false" schemeid="DP_TJ02" init-action="" description="门诊普通药品统计报表" system_product_code="hospital_oc" title="门诊普通药品统计报表" remark="门诊普通药品统计报表" flag="chart" type="chart"><%
	Map<String, Object> a = null;
	if(!CommonFun.isNe(request.getParameter("djbh"))){
		a = BillAction.init("hospital_oc.chart.chart.DP_TJ02", (String)request.getParameter("djbh"));
	} else if(!CommonFun.isNe(request.getParameter("gzid"))){
		a = BillAction.initFromCache("hospital_oc.chart.chart.DP_TJ02", (String)request.getParameter("gzid"));
	} else if(!CommonFun.isNe(request.getParameter("p_dj_sn"))){
		a = BillAction.initFromCacheMX(request.getParameter("p_pageid"), "hospital_oc.chart.chart.DP_TJ02", (String)request.getParameter("ptableid"), (String)request.getParameter("p_dj_sn"), (String)request.getParameter("p_dj_sort"), (String)request.getParameter("p_gzid"));
	} else {
		a = BillAction.init("hospital_oc.chart.chart.DP_TJ02", null);
	}
...
<s:row type="frow"><s:textfield label="科室名称" cols="1" name="dept_name" placeholder="" fdtype="字符" defaultValue="" format="" nextfocusfield="" islabel="否" readonly="false" required="否" encryption="否" create_action="" modify_action="" enter_action="" dbl_action="zl_select_DP_TJ02_01" out_action="" tableid="" expressions="" maxlength="128" precision="">${empty dept_name ? '' : dept_name}</s:textfield>
</s:row>
...
<s:table.field name="amount" value="${empty amount ? '' : amount}" fdtype="字符" format="" dictionary="" label="数量" size="16" maxlength_show="" digitsize="4" precision="" available="true" sort="true" controltype="" align="right" width="60" fieldorder="6" is_href="" app_field=""></s:table.field>
...
<s:table.field name="操作" value="$[操作]"  fdtype="字符" format="" dictionary="" label="操作" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="textfield" align="left" width="250" fieldorder="8" is_href="hospital_oc.chart.chart.DP_TJ02_01" app_field="" datatype="template"><s:textfield readonly="true" name="操作" value="$[操作]"  fdtype="字符" format="" dictionary="" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="textfield" align="left" width="250" fieldorder="8" is_href="hospital_oc.chart.chart.DP_TJ02_01" app_field="">null</s:textfield>
</s:table.field>
</s:table.fields>
</s:table>
...
<s:table.field name="druggg" value="${empty druggg ? '' : druggg}" fdtype="字符" format="" dictionary="" label="药品规格" size="" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="150" fieldorder="2" is_href="" app_field=""></s:table.field>
...
<s:table.field name="drug_name" value="${empty drug_name ? '' : drug_name}" fdtype="字符" format="" dictionary="" label="药品名称" size="360" maxlength_show="" digitsize="" precision="" available="true" sort="true" controltype="" align="left" width="250" fieldorder="1" is_href="" app_field=""></s:table.field>
...
<s:table.field name="charges" value="${empty charges ? '' : charges}" fdtype="实数" format="" dictionary="" label="金额" size="14" maxlength_show="" digitsize="2" precision="" available="true" sort="true" controltype="" align="right" width="30" fieldorder="6" is_href="" app_field=""></s:table.field>
<s:table.field name="amount" value="${empty amount ? '' : amount}" fdtype="字符" format="" dictionary="" label="数量" size="16" maxlength_show="" digitsize="4" precision="" available="true" sort="true" controltype="" align="right" width="30" fieldorder="7" is_href="" app_field=""></s:table.field>
