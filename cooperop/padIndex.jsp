...
<style>
	...
	#header_notice_bar:hover{
		height: unset;
		overflow: unset;
		line-height: 25px;
		/* border: 1px solid #efefef; */
		background: #fffde2f7;
		box-shadow: 0px 0px 7px 2px #f1eded;
	}
</style>
<div class="container">
	<div class="layout-header">
		<div class="header-cr">
			...
			<div class="topbar">
				<div class="clearfix">
					<div class="menu-item">
						<a href="javascript: void(0);" id="header_notice_bar" style="color:#961515;">
					...
					<div class="userinfo">
						...
						<ul class="btnbox">
							...
							<li><!-- <a class="exitbtn" id="exitbtn" href="javascript: void(0);">注销</a>
								...
								<a class="" id="" href="javascript: void(0);" onclick="$.logout();">退出</a>
							</li>
						</ul>
					</div>
					<div class="nav-list">
...
$(document).ready(function(){
	if(typeof CefSharp != "undefined"){
		CefSharp.BindObjectAsync("crtech");
	}
	$.tabwindowinit();
	...
	setTimeout(function (){
		$cimc.init({
			userid: userinfo.id ,
			_CRSID: $.cookie('_CRSID')
		});
	}, 2000);

	setTimeout(function (){
		var is_tz = getRequest();
		if(is_tz != {} && is_tz.page){
			//"openTabPage": function (pageid, title, url, need_refresh, params, ding)
			//if (is_tz.page.indexOf('patsimic') >= 0){
			$.openTabPage('crtech.'+is_tz.page,'右键菜单页面',is_tz.page,true,null,null);
			//}
		}
	}, 1000);
});
