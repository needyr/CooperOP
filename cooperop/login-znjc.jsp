...
<head>
    ...
    <title>欢迎登录</title>
    <link href="${pageContext.request.contextPath}/theme/logins/login-znjc/css/login-cz.css" rel="stylesheet"
          type="text/css"/>
</head>
<body class="version3">
<div class="login-container">
    ...
    <div class="login-wrap">
            ...
            <div class="forms">
                <form class="login-Div" id="login-form" action="" method="post" onsubmit="submitMe();return false;">
                    <div class="form-element">
                        <input class="input-field" type="text" name="userid" placeholder="用户名/手机号/邮箱">
                        <i class="icons">
        ...
        <div class="logindiv finger finger-div" style="display: none">
            <div class="scan">
...
<script src="${pageContext.request.contextPath}/theme/scripts/controls/controls.js"
        type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/theme/logins/login-znjc/scripts/login-cz.js"
        type="text/javascript"></script>
<script>
