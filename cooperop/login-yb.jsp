...
<head>
    ...
    <title>欢迎登录</title>
    <link href="${pageContext.request.contextPath}/theme/logins/login-yb/css/login-cz.css" rel="stylesheet"
          type="text/css"/>
</head>
<body>
        ...
        <div style="display: flex;
            ...
            <div class="copyright">
                <ul>
                    ...
                    <li class="font14" style="padding-left: 15px;"><span>${qyxx}</span>
                    </li>
                </ul>
            </div>
        </div>
...
<script src="${pageContext.request.contextPath}/theme/scripts/controls/controls.js"
        type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/theme/logins/login-yb/scripts/login-cz.js"
        type="text/javascript"></script>
<script>
