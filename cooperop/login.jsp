...
<%
	...
	pageContext.setAttribute("login_page", SystemConfig.getSystemConfigValue("hospital_common", "login.page"));
...
<body>
				...
				<form id="loginForm" action="" method="post" onsubmit="submitMe();return false;">
					...
					<div class="logindiv qr-code">
						...
						<div id="login_container">
							<img style="width: 300px;margin-top: 60px;height: 300px;border: 1px solid #c5c5c5;display: inline;" alt="微信二维码" src="${pageContext.request.contextPath}/theme/img/wx.jpg">
							<span style="display: block;">请使用微信扫描二维码登录</span>
							<span>医策智能辅助决策支持云平台</span>
						</div>
					</div>
				</form>
				<div class="others">
	...
	<div class="index-foot">
		<a href="login-znjc.jsp">智能辅助决策支持平台</a>
		　/　
		<a href="login-jxh.jsp">医院大数据精细化运营管理平台</a>
		　/　
		<a href="login-yb.jsp">医院医保大数据管理平台</a>
	</div>
</body>
...
jQuery(document).ready(
	function() {
		if ('${login_page}' != '' && '${login_page}' != 'login') {
